  ...
  return (
    ...
    >
      <div className="iw-screen" style={screenStyle(GPS_SCREEN)}>
        <div className="iw-lcd-row">
          <span className="iw-lcd-label notranslate" translate="no">{label ?? "—"}</span>
          <span className={sourceKind === "ip" ? "iw-lcd-amber" : undefined}>{sourceLabel}</span>
        </div>
        <div className="iw-lcd-row notranslate" translate="no">
          <span>{latDMS}</span>
          <span className="iw-lcd-dim">{latDec}</span>
        </div>
        <div className="iw-lcd-row notranslate" translate="no">
          <span>{lonDMS}</span>
          <span className="iw-lcd-dim">{lonDec}</span>
        </div>
