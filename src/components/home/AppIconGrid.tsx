...
import { BookOpen, Users, Ship, ClipboardList, FlaskConical, BookA, Settings, Sparkles, StickyNote, GraduationCap, type LucideIcon } from "lucide-react";
...
const APPS: AppIcon[] = [
  ...
  { label: "Sınav Hazırlık", to: "/exam-preparation", Icon: GraduationCap, gradient: "linear-gradient(135deg, #f43f5e 0%, #9f1239 100%)" },
