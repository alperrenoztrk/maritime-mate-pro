  ...
  return (
    <div
      className={cn(
        ...
        "marine-shell relative min-h-[100svh] w-full overflow-x-hidden text-foreground antialiased",
        className
      )}
    >
      ...
      <main
        className={cn(
          ...
          // The keyed route frame globally reserves AppNavBar. This layout
          // only adds the page's local breathing room.
          "pt-3",
