...
const content: ContentMap = {
  ...
  thermodynamics: {
      ...
      sections: [
        {
          ...
          diagram: { src: "/diagrams/machine/termodinamik-sistem.svg", alt: "Classification of thermodynamic systems - closed, open and isolated", caption: "Figure: comparison of closed, open and isolated systems" }
        },
        {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Mutlak basınç (Pabs), sıfır referansına göre ölçülür. Manometrik basınç (Pgauge) atmosfer basıncını referans alır."
          ],
          formula: {
            expression: "Pabs = Pgauge + Patm",
            variables: [
              "Pabs: Mutlak basınç (bar)",
              "Pgauge: Manometrik basınç (bar)",
              "Patm: Atmosfer basıncı ≈ 1.01325 bar"
            ]
          },
          example: {
            ...
            steps: [
              "Pabs = Pgauge + Patm",
              "Pabs = 7.5 + 1.013 = 8.513 bar"
            ],
            result: "Absolute pressure is 8.513 bar."
          }
        },
        {
          heading: "Sıcaklık",
      ...
      sections: [
        ...
        },
        {
          ...
          example: {
            ...
            result: "Required heat power is 16.67 kW."
          }
        }
      ],
      keyPoints: [
      ...
      sections: [
        {
          ...
          example: {
            ...
            result: "The gas did 50 kJ of work."
          }
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          example: {
            ...
            result: "Economizer provides 330 kW of heat power."
          }
        }
      ],
      keyPoints: [
      ...
      sections: [
        {
          ...
          formula: {
            expression: "dS = δQrev / T",
            variables: [
              "dS: Entropi değişimi (kJ/K)",
              "δQrev: Tersinir ısı transferi (kJ)",
              "T: Mutlak sıcaklık (K)"
            ]
          }
        },
        {
          ...
          example: {
            ...
            result: "Entropy change is +0.299 kJ/kg·K (entropy increased)."
          }
        }
      ],
      keyPoints: [
      ...
      sections: [
        {
          ...
          example: {
            ...
            result: "Air mass in the tank is 6.77 kg."
          }
        },
        {
      ...
      sections: [
        {
          ...
          diagram: { src: "/diagrams/machine/carnot-cevrimi.svg", alt: "Carnot cycle T-S diagram", caption: "Figure: the four reversible processes of the Carnot cycle on a T-S diagram" }
        },
        {
          ...
          formula: {
            expression: "ηCarnot = 1 − TL / TH",
            variables: [
              "ηCarnot: Carnot verimi",
              "TL: Düşük sıcaklık kaynağı (K)",
              "TH: Yüksek sıcaklık kaynağı (K)"
            ]
          },
          example: {
            ...
            steps: [
              "ηCarnot = 1 − TL / TH",
              "ηCarnot = 1 − 600 / 1800 = 1 − 0.333 = 0.667"
            ],
            result: "Maximum theoretical efficiency is %66.7. Actual efficiency is below this due to friction and other losses."
          }
        }
      ],
      keyPoints: [
        "Carnot verimi aşılamaz; gerçek verim her zaman altındadır.",
        "TH arttıkça veya TL azaldıkça verim artar.",
        ...
        },
        {
          ...
          example: {
            ...
            steps: [
              "r^(γ−1) = 18^0.4 = 3.178",
              "ρ^γ = 2.5^1.4 = 3.607",
              "η = 1 − [1/3.178] × [(3.607 − 1) / (1.4 × (2.5 − 1))]",
              "η = 1 − 0.3147 × [2.607 / 2.1]",
              "η = 1 − 0.3147 × 1.2414 = 1 − 0.3907 = 0.609"
            ],
            result: "Termik verim %60.9'dur."
          }
        },
        {
      ...
      sections: [
        {
          ...
          example: {
            ...
            result: "Heat flux through the cylinder wall is 225 kW."
          }
        },
        {
      ...
      sections: [
        {
          ...
          example: {
            ...
            steps: [
              "Ters akışta: ΔT₁ = Tyağ,giriş − Tsu,çıkış = 75 − 40 = 35°C",
              "ΔT₂ = Tyağ,çıkış − Tsu,giriş = 45 − 30 = 15°C",
    ...
    "Fouling ve temizlik etkileri": { title: "Fouling ve Temizlik Etkileri", introduction: "Fouling, ısı transfer yüzeylerinde biriken tortunun ısıl direnci artırması ve performansı düşürmesidir.", sections: [{ heading: "Fouling Tipleri", paragraphs: ["Deniz suyu tarafında biyolojik fouling (deniz canlıları) ve mineral çökelme, yağ tarafında karbon ve çamur birikimi, egzoz tarafında kurum ve asit yoğuşması fouling kaynağıdır."], table: { headers: ["Fouling Tipi", "Rf (m²·K/W)"], rows: [["Temiz deniz suyu", "0.00009"], ["Kirli deniz suyu", "0.0003"], ["Motor yağı", "0.0002"], ["Egzoz gazı", "0.002"]] } }], keyPoints: ["Fouling, U değerini önemli ölçüde düşürür.", "Periyodik temizlik enerji verimliliğini korur.", "Tasarımda fouling payı (%15-25) bırakılır."] },
    "Eşanjör verim hesapları": { title: "Eşanjör Verim Hesapları", introduction: "Eşanjör etkinliği (ε), gerçek ısı transferinin maksimum olası ısı transferine oranıdır.", sections: [{ heading: "NTU-Etkinlik Yöntemi", paragraphs: ["Qmax = Cmin × (Th,giriş − Tc,giriş) formülüyle tanımlanır. ε = Qgerçek / Qmax.", "NTU = UA / Cmin olarak hesaplanır. NTU arttıkça etkinlik artar ancak maliyet de artar."], formula: { expression: "ε = Q / Qmax = Q / [Cmin × (Th,in − Tc,in)]", variables: ["Cmin: Minimum ısı kapasitesi akışı (kW/K)"] } }], keyPoints: ["ε = 1.0 değerine ulaşmak pratik olarak mümkün değildir.", "Gemi eşanjörlerinde ε genellikle 0.6-0.85 arasındadır.", "NTU yöntemi çıkış sıcaklıkları bilinmediğinde kullanılır."] },
  ...
  "diesel-engines": {
    ...
    "İndike güç (indicated power) hesabı": { title: "İndike Güç Hesabı", introduction: "İndike güç, silindir içinde gaz basıncının pistona yaptığı iş sonucu üretilen güçtür. Motor performansının temel parametresidir.", sections: [{ heading: "Hesap Yöntemi", paragraphs: ["İndikatör diyagramından ortalama indike basınç (MIP) belirlenir. İndike güç aşağıdaki formülle hesaplanır."], formula: { expression: "Pi = (MIP × A × L × N × n) / (60 × k)", variables: ["Pi: İndike güç (kW)", "MIP: Ortalama indike basınç (kPa)", "A: Piston alanı (m²)", "L: Strok (m)", "N: Devir (rpm)", "n: Silindir sayısı", "k: 1 (2 zamanlı), 2 (4 zamanlı)"] }, example: { problem: "6 silindirli iki zamanlı motorun MIP = 1850 kPa, silindir çapı 500 mm, strok 2000 mm, devir 105 rpm ise indike gücü hesaplayınız.", steps: ["A = π/4 × 0.5² = 0.1963 m²", "Pi = (1850 × 0.1963 × 2.0 × 105 × 6) / (60 × 1)", "Pi = (1850 × 0.1963 × 2.0 × 630) / 60", "Pi = 457200 / 60 = 7620 kW" ], result: "Indicated power is 7620 kW (approximately 10360 HP)." } }], keyPoints: ["İndike güç, mekanik kayıplar hariç brüt güçtür.", "Fren gücü = İndike güç × Mekanik verim.", "İndikatör diyagramı yanma kalitesinin en önemli göstergesidir."] },
    "Özgül yakıt tüketimi (SFOC)": { title: "Özgül Yakıt Tüketimi (SFOC)", introduction: "SFOC, motor tarafından birim güç üretimi için tüketilen yakıt miktarıdır. Motor veriminin en doğrudan göstergesidir.", sections: [{ heading: "Tanım ve Hesap", paragraphs: [], formula: { expression: "SFOC = (Fuel consumption (g/h)) / (Brake power (kW))", variables: ["SFOC birimi: g/kWh"] }, example: { problem: "Bir ana motor 12500 kW fren gücü üretirken saatte 2500 kg HFO tüketiyorsa SFOC değerini hesaplayınız.", steps: ["SFOC = (2500 × 1000 g/h) / 12500 kW", "SFOC = 2500000 / 12500 = 200 g/kWh"], result: "SFOC = 200 g/kWh. In modern low-speed engines, this value is in the range of 160-175 g/kWh." } }], keyPoints: ["Düşük SFOC yüksek verim demektir.", "SFOC motor yüküne göre değişir; optimum genellikle %75-85 yükte elde edilir.", "ISO düzeltmesi ile referans koşullara dönüştürülür."] },
  },
  ...
  electrical: {
    ...
    "Üç fazlı asenkron motor": { title: "Üç Fazlı Asenkron Motor", introduction: "Gemi elektrik tüketicilerinin büyük çoğunluğu üç fazlı asenkron (indüksiyon) motorlardır. Pompa, fan, kompresör ve vinç tahriklerinde kullanılır.", sections: [{ heading: "Çalışma Prensibi", paragraphs: ["Stator sargılarına uygulanan üç fazlı gerilim döner manyetik alan oluşturur. Rotor bu alana göre hafif geri kalarak (kayma) döner. Kayma oranı genellikle %2-5 arasındadır."], formula: { expression: "ns = 120f/P    ve    kayma (s) = (ns − nr) / ns", variables: ["ns: Senkron devir (rpm)", "nr: Rotor devri (rpm)", "P: Kutup sayısı", "f: Frekans (Hz)"] }, example: { problem: "4 kutuplu, 60 Hz'lik bir motorun senkron devri ve %3 kayma ile çalışma devri nedir?", steps: ["ns = 120 × 60 / 4 = 1800 rpm", "nr = ns × (1 − s) = 1800 × (1 − 0.03) = 1746 rpm"], result: "The engine operates at 1746 rpm." } }], keyPoints: ["Basit, sağlam ve bakım ihtiyacı azdır.", "Yol verme akımı nominal akımın 5-7 katı olabilir.", "VFD ile hız kontrolü enerji tasarrufu sağlar."] },
    "Motor yol verme yöntemleri (DOL, Y-Δ, VFD)": { title: "Motor Yol Verme Yöntemleri", introduction: "Büyük motorların yol verilmesinde çekilen yüksek akım, jeneratör ve şebeke üzerinde gerilim düşümüne neden olur. Farklı yol verme yöntemleri bu etkiyi azaltır.", sections: [{ heading: "Yöntemler", paragraphs: [], table: { headers: ["Yöntem", "Başlangıç Akımı", "Başlangıç Torku", "Uygulama"], rows: [["DOL (Direkt)", "6-7 × In", "%100", "Küçük motorlar (< 15 kW)"], ["Y-Δ", "2-2.5 × In", "%33", "Orta boy motorlar"], ["Soft Starter", "2-4 × In", "Ayarlanabilir", "Pompa, fan"], ["VFD", "< 1.5 × In", "%100+", "Hassas hız kontrolü"]] } }], keyPoints: ["Y-Δ yol verme torku %33'e düşürür; ağır yüklerde uygun olmayabilir.", "VFD frekans kontrolü ile hem yumuşak yol verme hem enerji tasarrufu sağlar.", "Yol verme akımı jeneratör kapasitesine göre sınırlandırılmalıdır."] },
  },
  ...
  "fluid-mechanics": {
    ...
    "NPSH kavramı ve kavitasyon": { title: "NPSH Kavramı ve Kavitasyon", introduction: "NPSH (Net Positive Suction Head), pompanın emme tarafında kavitasyon oluşumunu önlemek için gereken minimum basınç yüksekliğidir.", sections: [{ heading: "NPSH Tanımları", paragraphs: ["NPSHA (Available): Sistemin pompaya sağladığı emme yüksekliği.", "NPSHR (Required): Pompa üreticisinin kavitasyondan kaçınmak için belirttiği minimum değer.", "Güvenli çalışma koşulu: NPSHA > NPSHR + güvenlik payı (genellikle 0.5-1.0 m)."], formula: { expression: "NPSHA = (Patm − Pvapor) / ρg + hstatic − hloss", variables: ["Pbuhar: Sıvının buhar basıncı (Pa)", "hstatik: Sıvı seviyesi (m)", "hkayıp: Emme hattı sürtünme kaybı (m)"] } }, { heading: "Kavitasyon", paragraphs: ["Kavitasyon, lokal basıncın sıvının buhar basıncının altına düşmesiyle oluşan buhar kabarcıklarının yüksek basınç bölgesinde çökmesidir. Metal yüzeylerde erozyon, gürültü ve titreşime neden olur."] }], keyPoints: ["Kavitasyon pompa çarkını ciddi şekilde aşındırır.", "Sıvı sıcaklığı arttıkça buhar basıncı artar, NPSHA düşer.", "Pompa pozisyonu mümkün olduğunca sıvı seviyesinin altında olmalıdır."] },
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  "cooling-hvac": {
    "COP (Performans Katsayısı) hesabı": { title: "COP (Performans Katsayısı) Hesabı", introduction: "COP, soğutma veya ısı pompası sisteminin verimini ifade eden boyutsuz büyüklüktür.", sections: [{ heading: "Soğutma COP", paragraphs: ["Soğutma etkisinin kompresör işine oranıdır."], formula: { expression: "COPcooling = Qevaporator / Wcompressor = (h₁ − h₄) / (h₂ − h₁)", variables: ["h₁: Kompresör girişi (evaporatör çıkışı) entalpisi", "h₂: Kompresör çıkışı entalpisi", "h₄: Genleşme valfi çıkışı entalpisi"] }, example: { problem: "Bir geminin provizyon soğutma sisteminde h₁ = 400 kJ/kg, h₂ = 450 kJ/kg, h₃ = h₄ = 250 kJ/kg ise COP'u hesaplayınız.", steps: ["COP = (h₁ − h₄) / (h₂ − h₁)", "COP = (400 − 250) / (450 − 400) = 150 / 50 = 3.0"], result: "COP = 3.0: 3 kW of cooling is provided with 1 kW of electricity." } }], keyPoints: ["COP > 1 olması normaldir (verimle karıştırılmamalıdır).", "Evaporatör ve kondenser sıcaklıkları COP'u doğrudan etkiler.", "Fouling ve gaz sızıntısı COP'u düşürür."] },
  },
  ...
  "machine-elements": {
    "Kristal yapılar ve faz diyagramları": {
      ...
      sections: [
        ...
        { heading: "Kritik Sıcaklıklar", paragraphs: ["A₁ (723°C): Ötektoid dönüşüm sıcaklığı. Perlit ↔ östenit dönüşümü. A₃: Hipoötektoid çeliklerde ferrit → östenit tamamlanma sıcaklığı. Acm: Hiperötektoid çeliklerde sementit çözünme sıcaklığı.", "Isıl işlem (tavlama, sertleştirme, menevişleme) bu kritik sıcaklıklara göre planlanır."] }
      ],
    ...
    "Normal gerilme ve deformasyon": {
      ...
      sections: [
        { heading: "Normal Gerilme (σ)", paragraphs: ["Kesit alanına dik etki eden kuvvet, normal gerilme oluşturur. Çekme (+) veya basma (−) olabilir."], formula: { expression: "σ = F / A", variables: ["σ: Normal gerilme (MPa = N/mm²)", "F: Eksenel kuvvet (N)", "A: Kesit alanı (mm²)"] }, example: { problem: "Çapı 50 mm olan bir çelik çubuğa 100 kN çekme kuvveti uygulanmaktadır. Gerilmeyi hesaplayınız.", steps: ["A = π/4 × 50² = 1963.5 mm²", "σ = F/A = 100000 / 1963.5 = 50.9 MPa"], result: "The tensile stress is 50.9 MPa." } },
        { heading: "Birim Uzama (ε)", paragraphs: ["Birim uzama, orijinal boya göre uzama miktarıdır: ε = ΔL / L₀. Boyutsuz bir büyüklüktür, genellikle yüzde (%) olarak ifade edilir."], diagram: { src: "/diagrams/machine/gerilme-gerinim.svg", alt: "Stress-strain diagram (steel)", caption: "Figure: typical stress-strain curve for steel" } }
      ],
      keyPoints: ["Gerilme birimi: 1 MPa = 1 N/mm² = 10⁶ Pa.", "Güvenlik katsayısı ile emniyet gerilmesi belirlenir: σizin = σakma / n.", "Denizcilik uygulamalarında n = 2-4 arasında seçilir."]
    },
    ...
    "Mil çapı hesabı (burulma ve eğilme)": {
      ...
      sections: [
        { heading: "Bileşik Yükleme", paragraphs: ["Gerçek çalışma koşullarında miller hem eğilme hem burulma yüküne aynı anda maruz kalır. Eşdeğer moment yöntemi veya Von Mises kriteri kullanılır."], formula: { expression: "d ≥ ³√(16/(π×τizin) × √(M² + T²))", variables: ["d: Mil çapı (mm)", "M: Eğilme momenti (N·mm)", "T: Tork (N·mm)", "τizin: İzin verilen kayma gerilmesi (MPa)"] }, example: { problem: "Bir pompa miline 2 kN·m eğilme momenti ve 5 kN·m tork etki etmektedir. τizin = 40 MPa ise gerekli mil çapını hesaplayınız.", steps: ["Te = √(M² + T²) = √(2² + 5²) × 10⁶ = √29 × 10⁶ = 5.385 × 10⁶ N·mm", "d = ³√(16Te/(π×τ)) = ³√(16 × 5.385×10⁶ / (π × 40))", "d = ³√(86.16×10⁶ / 125.66) = ³√(685700) = 88.1 mm"], result: "The minimum shaft diameter is 88 mm; 90 mm is selected as the standard diameter." } }
      ],
  ...
  "fuel-technology": {
    ...
    "Bunker planlama ve sipariş": {
      ...
      sections: [
        { heading: "Planlama", paragraphs: ["Sefer planına göre yakıt tüketimi hesaplanır: Tüketim = SFOC × Güç × Süre. Güvenlik payı (%10-15), kötü hava payı ve bekleme süreleri eklenir.", "ECA bölgeleri için düşük kükürtlü yakıt miktarı ayrıca planlanır."], formula: { expression: "Required fuel (ton) = SFOC (g/kWh) × Power (kW) × Duration (h) / 10⁶ + Safety margin", variables: [] }, example: { problem: "Ana motor 8000 kW'ta 12 gün seyir edecek, SFOC = 175 g/kWh. %15 güvenlik payı ile gerekli yakıt miktarını hesaplayınız.", steps: ["Süre = 12 × 24 = 288 saat", "Yakıt = 175 × 8000 × 288 / 10⁶ = 403.2 ton", "Güvenlik payı dahil = 403.2 × 1.15 = 463.7 ton"], result: "Approximately 464 tons of HFO should be ordered." } }
      ],
...
import content11 from "./machineTopicDetailContent11";

const allContentMaps = [content, content2, content3, content4, content5, content6, content7, content8, content9, content10, content11];
