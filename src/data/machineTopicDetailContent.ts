...
const content: ContentMap = {
  ...
  electrical: {
    ...
    "Üç fazlı asenkron motor": { title: "Üç Fazlı Asenkron Motor", introduction: "Gemi elektrik tüketicilerinin büyük çoğunluğu üç fazlı asenkron (indüksiyon) motorlardır. Pompa, fan, kompresör ve vinç tahriklerinde kullanılır.", sections: [{ heading: "Çalışma Prensibi", paragraphs: ["Stator sargılarına uygulanan üç fazlı gerilim döner manyetik alan oluşturur. Rotor bu alana göre hafif geri kalarak (kayma) döner. Kayma oranı genellikle %2-5 arasındadır."], formula: { expression: "ns = 120f/P    ve    kayma (s) = (ns − nr) / ns", variables: ["ns: Senkron devir (rpm)", "nr: Rotor devri (rpm)", "P: Kutup sayısı", "f: Frekans (Hz)"] }, example: { problem: "4 kutuplu, 60 Hz'lik bir motorun senkron devri ve %3 kayma ile çalışma devri nedir?", steps: ["ns = 120 × 60 / 4 = 1800 rpm", "nr = ns × (1 − s) = 1800 × (1 − 0.03) = 1746 rpm"], result: "Motor 1746 rpm'de çalışır." } }], keyPoints: ["Basit, sağlam ve bakım ihtiyacı azdır.", "Yol verme akımı nominal akımın 5-7 katı olabilir.", "VFD ile hız kontrolü enerji tasarrufu sağlar."] },
