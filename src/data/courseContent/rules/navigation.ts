    ...
    rules: [
      ...
      },
      {
        ...
        content: [
          ...
          "Kural 13 — Geçme: Bir gemiyi geçen gemi, geçilen gemiye yol vermekle yükümlüdür. Kıç taraftan 22.5° dışındaki açıdan yaklaşan gemi geçiyor sayılır.",
          ...
          "Kural 19 — Kısıtlı Görüşte Seyir: Emniyetli hıza düşülmeli; radar ile tespit edilen gemilerden sancağa dönülerek kaçılmalıdır.",
        ],
      },
    ],
  },
