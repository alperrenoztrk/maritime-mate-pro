...
const content7: ContentMap = {
  ...
  "energy-efficiency": {
    ...
    "Hız optimizasyonu (slow steaming)": {
      ...
      sections: [
        { heading: "Fiziksel Temel", paragraphs: ["Yakıt tüketimi gemi hızının yaklaşık küpü ile orantılıdır (P ∝ V³). Bu ilişki nedeniyle hızın %10 düşürülmesi yakıt tüketimini yaklaşık %27 azaltır."], formula: { expression: "P₂/P₁ ≈ (V₂/V₁)³", variables: ["P: Güç (kW)", "V: Hız (knot)"] }, example: { problem: "15 knot'ta 12000 kW güç gerektiren bir geminin 12 knot'ta ihtiyaç duyacağı gücü hesaplayınız.", steps: ["P₂ = P₁ × (V₂/V₁)³", "P₂ = 12000 × (12/15)³", "P₂ = 12000 × 0.512 = 6144 kW"], result: "The required power at 12 knots is 6144 kW (49% reduction)." } },
