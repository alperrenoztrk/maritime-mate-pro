...
const stageLabels = ["Kaynak / girdi", "Dönüşüm", "Kontrol", "Çıktı", "Emniyet / kanıt"] as const;
...
const topicSeeds: Record<string, TopicSeed> = {
  "deck-machinery/0": seed({
    ...
    flow: ["Elektrik veya hidrolik güç", "Motor, redüktör ve kavrama", "Wildcat ile bant freni", "Zincir, stopper ve demir", "Köprü-başüstü komutu; akım/basınç kaydı"],
  ...
  "deck-machinery/1": seed({
    ...
    flow: ["Elektrik/hidrolik güç", "Motor-pompa, vinç ve fren", "Hoist/luff/slew kumandası", "Tel, blok, kanca ve yük", "Limit/overload, SWL işareti ve lifting register"],
  ...
  "deck-machinery/2": seed({
    ...
    flow: ["Elektrik/hidrolik güç", "Motor, redüktör ve tambur", "Kavrama, fren ve tension kontrolü", "Halat-fairlead-bollard yük yolu", "Mooring planı, brake test ve vardiya turu"],
  ...
  "deck-machinery/3": seed({
    ...
    flow: ["Hidrolik güç veya haricî kaldırma", "Silindir, zincir/teker ve ray", "Limit, kilit ve panel hizası", "Conta-compression bar-drenaj", "Ultrasonic/hose test ve bakım kaydı"],
  ...
  "deck-machinery/4": seed({
    ...
    flow: ["Elektrik/hidrolik güç", "Dikey motor-redüktör", "Warping head ve ayak kumandası", "Halat, fairlead ve elle kontrollü kuyruk", "Acil stop, exclusion zone ve PMS"],
  ...
  "nav-systems/0": seed({
    ...
    flow: ["X/S-band verici ve döner anten", "Eko alıcısı, tuning ve clutter işleme", "Gyro, log/GNSS ve operatör ayarları", "PPI, EBL/VRM, PI, trails ve ARPA", "Görsel gözcülük, ikinci radar/harita ve VDR"],
  ...
  "nav-systems/1": seed({
    ...
    flow: ["Resmî ENC/RNC, permit ve güncellemeler", "ECDIS çekirdeği, SENC ve presentation library", "GNSS, gyro, log ve manuel/bağımsız fix", "Safety ayarları, route check ve monitoring", "Alarm yönetimi, backup ECDIS/harita, bridge team ve VDR"],
  ...
  "nav-systems/2": seed({
    ...
    flow: ["GNSS, gyro/ROT ve statik-voyage data", "AIS transponder ve TDMA zamanlama", "VHF 1/2 yayın-alım", "MKD/ECDIS/radar hedef sunumu", "Görsel/radar doğrulama ve AIS test/kayıt"],
  ...
  "nav-systems/3": seed({
    ...
    flow: ["GNSS takımyıldızları ve augmentation", "Anten, alıcı, RAIM/integrity", "Position-time-COG/SOG hesabı", "ECDIS/AIS/radar/VDR dağıtımı", "İkinci kaynak, radar/visual fix ve PNT alarmı"],
  ...
  "nav-systems/4": seed({
    ...
    flow: ["Dünya dönüşü/atalet veya manyetik alan", "Gyro master ya da pusula kartı", "Correction ve repeater dağıtımı", "Steering/radar/ECDIS/AIS heading", "Azimuth/transit/amplitude check ve compass record"],
  ...
  "nav-systems/5": seed({
    ...
    flow: ["Transducer ve akustik pulse", "Su sütunu ve dip echo'su", "Receiver, gain/range ve bottom tracking", "Depth display, shallow alarm ve VDR", "Chart/tide/lead line veya ikinci yöntemle UKC kontrolü"],
  ...
  "main-engine/0": seed({
    ...
    flow: ["Yakıt, scavenge hava ve cylinder oil", "Silindir-piston-crosshead yanması", "Krank, thrust bearing ve şaft", "FPP pervane itişi", "Alarm/trip, indicator diagram ve engine log"],
  ...
  "main-engine/1": seed({
    ...
    flow: ["Yakıt, charge air, LO ve cooling water", "Piston-biyel-krank dört zaman çevrimi", "Governor ve turbocharger", "Alternator veya reduction gear/CPP", "Protection, trend ve PMS"],
  ...
  "main-engine/2": seed({
    ...
    flow: ["Krank/gear çıkış torku", "Thrust, intermediate ve tail shaft", "Bearings, coupling ve stern tube", "Pervane torku/itme", "Vibration, temperature, oil level ve wear-down kayıtları"],
  ...
  "main-engine/3": seed({
    ...
    flow: ["Shaft torque/rpm veya CPP hydraulic power", "Hub ve blade pitch", "Wake içinde momentum değişimi", "Thrust ve gemi hızı", "Shaft power, vibration, pitch feedback ve underwater inspection"],
  ...
  "main-engine/4": seed({
    ...
    flow: ["Helm/autopilot komutu ve gyro", "Control/telemotor ve hydraulic pumps", "Ram/rotary vane, tiller ve stock", "Rudder angle ve yaw response", "Alarm, emergency steering comms ve test record"],
  ...
  "auxiliary/0": seed({
    ...
    flow: ["Yakıt-hava-LO/CW ve start air", "Dizel motor + governor", "Alternatör + AVR", "MSB, breaker ve yük paylaşımı", "Protection, kW/kVAr trendi ve blackout record"],
  ...
  "auxiliary/1": seed({
    ...
    flow: ["Feedwater, fuel/air veya exhaust heat", "Furnace/economizer ve evaporation", "Steam drum, separator ve safety valve", "Steam consumers ve condensate return", "Level/flame/pressure trips, water test ve boiler log"],
  ...
  "auxiliary/2": seed({
    ...
    flow: ["Settling/service tanktan şartlandırılmış yağ", "Heater, feed pump ve regulating valve", "High-speed bowl/disc stack", "Clean oil, separated water ve sludge", "RPM/vibration/temp alarmı, sludge log ve sampling"],
  ...
  "auxiliary/3": seed({
    ...
    flow: ["Atmosfer havası ve suction filter", "LP/HP stages + intercooler", "Moisture separator ve non-return", "Air receiver ve dağıtım", "High-temp/pressure trips, drains ve receiver survey"],
  ...
  "auxiliary/4": seed({
    ...
    flow: ["Tank/sea suction ve net positive head", "Impeller veya displacement element", "Casing, seal ve bearing", "Discharge line/control valve", "Pressure-flow-current, relief ve leak record"],
  ...
  "auxiliary/5": seed({
    ...
    flow: ["Seawater + waste heat veya RO pressure", "Evaporator/condenser ya da membranes", "Demister/salinity cell", "Distillate tank ve treatment", "Salinity dump, production log ve water test"],
  ...
  "auxiliary/6": seed({
    ...
    flow: ["Sınıflandırılmış sludge/garbage feed", "Primary-secondary chamber ve burner", "Air control ve temperature interlock", "Flue gas ve ash", "Incinerator/sludge record, alarm ve inspection"],
  ...
  "auxiliary/7": seed({
    ...
    flow: ["Bilge holding tank ve homogenized feed", "Coalescer/filter stages", "15 ppm bilge alarm sample cell", "Overboard veya automatic recirculation/stop", "ORB, valve/seal status ve calibration record"],
  ...
  "auxiliary/8": seed({
    ...
    flow: ["Black/grey water collection", "Aeration/bioreactor ve settling", "Disinfection/filtration", "Effluent veya holding/discharge", "Sample, sewage record/PMS ve certificate"],
  ...
  "auxiliary/9": seed({
    ...
    flow: ["Hot fluid ve cold fluid", "Plate/tube heat-transfer surface", "Control/bypass valve", "Conditioned outlet streams", "ΔT/ΔP trendi, leak test ve cleaning record"],
  ...
  "auxiliary/10": seed({
    ...
    flow: ["Evaporator ve room heat load", "Compressor", "Condenser + receiver", "Expansion valve ve evaporator", "Pressure/temp trips, refrigerant log ve food record"],
  ...
  "fire-safety/0": seed({
    ...
    flow: ["Sea chest/suction", "Main veya emergency fire pump", "Fire main, isolating valves ve ISC", "Hydrant-hose-nozzle", "Pressure test, valve plan ve PMS"],
  ...
  "fire-safety/1": seed({
    ...
    flow: ["CO₂ cylinders/tank ve pilot release", "Manifold, selector ve time delay/alarm", "Protected-space piping/nozzles", "Oxygen reduction ve fire suppression", "Muster/accounting, release cabinet seal ve service record"],
  ...
  "fire-safety/2": seed({
    ...
    flow: ["Water + approved foam concentrate", "Proportioner/inductor ve pump", "Foam solution/aeration", "Monitor/applicator ve blanket", "Concentration test, stock/expiry ve drill record"],
  ...
  "fire-safety/3": seed({
    ...
    flow: ["Fresh/sea water tank ve pump/gas source", "Section valve/detection-release logic", "Piping ve approved nozzles", "Localized cooling/suppression", "Section alarm, pressure test ve nozzle inspection"],
  ...
  "fire-safety/4": seed({
    ...
    flow: ["Boiler uptake veya IG generator gas", "Scrubber/cooler ve demister", "Blower + O₂ analyzer", "Deck seal/non-return ve deck main", "Tank pressure/O₂ trendi, alarms ve cargo log"],
  ...
  "fire-safety/5": seed({
    ...
    flow: ["Smoke/heat/flame detector ve manual call point", "Loop/zone wiring ve control panel", "Logic, fault ve alarm discrimination", "Audible/visual alarm ve interface", "Test log, isolation register ve detector cleaning"],
  ...
  "fire-safety/6": seed({
    ...
    flow: ["Approved extinguishing agent", "Cylinder/valve ve discharge mechanism", "Hose/nozzle application", "Fire class üzerinde local effect", "Seal/gauge/weight, location plan ve service tag"],
  ...
  "fire-safety/7": seed({
    ...
    flow: ["Compressed air/chemical oxygen source", "Cylinder/reducer veya hood generator", "Mask/hood ve demand flow", "Escape veya firefighting breathing", "Pressure/weight, low-air alarm ve service record"],
  ...
  "fire-safety/8": seed({
    ...
    flow: ["Remote pull/ESD komutu", "Cable/pneumatic/electric actuation", "Quick-closing valve, fan/damper ve pump stop", "Fuel/air/energy isolation", "Position verification, reset control ve test log"],
  ...
  "cargo-systems/0": seed({
    ...
    flow: ["Cargo tank/sump ve suction valves", "Centrifugal/deepwell/PD pump", "Cargo main, crossover ve manifold", "Shore/tank transfer", "Pressure/level/ESD, cargo log ve line-up check"],
  ...
  "cargo-systems/1": seed({
    ...
    flow: ["Selected crude oil source", "Cargo pump/heater ve COW main", "Fixed washing machines/programmer", "Tank surfaces ve stripping", "IG/O₂/pressure, COW checklist ve ORB"],
  ...
  "cargo-systems/2": seed({
    ...
    flow: ["Radar/servo/pressure sensor ve temp elements", "Signal processing + tank calibration", "Cargo monitoring display", "Level/volume/temp ve independent alarms", "Manual ullage cross-check, calibration ve cargo log"],
  ...
  "cargo-systems/3": seed({
    ...
    flow: ["Hydraulic/lift-away actuation", "Panels, hinges/rollers ve rails", "Cleats/locks", "Packing-compression bar-drainage", "Ultrasonic/hose test, survey ve cargo record"],
  ...
  "cargo-systems/4": seed({
    ...
    flow: ["Cargo unit weight/CG ve stow plan", "CSM/lashing calculation", "Twistlock, rod, turnbuckle/dunnage", "Ship structure/lashing point load path", "Inspection rounds, CSM record ve damaged gear quarantine"],
  ...
  "cargo-systems/5": seed({
    ...
    flow: ["Ship reefer distribution power", "Breaker/socket/cable", "Container controller/compressor/fans", "Cargo air temperature", "Monitoring system, alarm round ve reefer log"],
  ...
  "cargo-systems/6": seed({
    ...
    flow: ["Hydraulic/electric power", "Cylinders/winches/hinges", "Control + interlock", "Ramp/door ve locks/cleats", "Bridge indication, CCTV/round ve voyage checklist"],
  ...
  "cargo-systems/7": seed({
    ...
    flow: ["Certified lifting appliance ve power", "Hoist/luff/slew veya derrick rig", "Wire/block/hook/sling", "Cargo + ship structure load path", "SWL marking, register, pre-use check ve signal plan"],
  ...
  "cargo-systems/8": seed({
    ...
    flow: ["Wash water/crude/chemical medium", "Heater/pump ve tank cleaning main", "Fixed/portable machines", "Eductor/stripping ve slop tanks", "Atmosphere/pressure/temp, tank-cleaning log ve record book"],
  ...
  "environmental-auxiliary/0": seed({
    ...
    flow: ["Ballast intake ve sampling", "Filter + UV/electrochlorination/active substance", "Monitoring/control ve neutralization", "Treated ballast tank/discharge", "BWRB, alarms, calibration ve compliance sample"],
  ...
  "environmental-auxiliary/1": seed({
    ...
    flow: ["Bilge holding tank", "OWS/coalescer/filter", "15 ppm alarm sample loop", "Overboard veya recirculation/stop", "ORB, seals, calibration ve tank balance"],
  ...
  "environmental-auxiliary/2": seed({
    ...
    flow: ["Collection/holding", "Biological/physical treatment", "Disinfection ve effluent", "Approved discharge/reception", "Sample, certificate, valve line-up ve log"],
  ...
  "environmental-auxiliary/3": seed({
    ...
    flow: ["Segregated approved waste", "Feed/burner", "Primary-secondary combustion", "Flue gas + ash", "Temperature/interlock, sludge/garbage record ve PMS"],
  ...
  "environmental-auxiliary/4": seed({
    ...
    flow: ["Outside/return air", "Filter, coil ve fan", "Damper/duct control", "Conditioned occupied spaces", "Temp/humidity/pressure, fire damper ve hygiene PMS"],
  ...
  "environmental-auxiliary/5": seed({
    ...
    flow: ["Fresh-water storage ve pumps", "Hydrophore tank/air cushion", "Pressure switch/control", "Domestic distribution", "Pressure cycle, disinfection/sample ve tank inspection"],
  ...
  "environmental-auxiliary/6": seed({
    ...
    flow: ["Room/product heat", "Evaporator ve compressor", "Condenser/receiver", "Expansion ve recirculation", "Room/product log, alarm ve refrigerant PMS"],
  ...
  "environmental-auxiliary/7": seed({
    ...
    flow: ["Compressors", "Cooler/separator/dryer", "Receivers", "Start-control-working manifolds", "Pressure/dew point/drains, relief ve survey"],
  ...
  "environmental-auxiliary/8": seed({
    ...
    flow: ["Boiler steam header", "Reducing/control valves", "Consumers/tracing/coils", "Steam traps ve condensate return", "Pressure/temp, trap survey, water test ve insulation PMS"],
  ...
  "gmdss-lsa/0": seed({
    ...
    flow: ["VHF/MF/HF ve recognized mobile satellite service", "DSC/satellite terminals + identities", "GNSS/time ve reserve power", "Distress alert, voice/data ve MSI", "Radio log, daily/weekly/monthly tests ve shore service"],
  ...
  "gmdss-lsa/1": seed({
    ...
    flow: ["MMSI, GNSS/time ve operator input", "VHF DSC controller Ch 70", "VHF transmitter/antenna", "DSC acknowledgment + working-channel voice", "Radio log, self-test ve reserve power"],
  ...
  "gmdss-lsa/2": seed({
    ...
    flow: ["MMSI/GNSS + frequency selection", "DSC controller ve transmitter", "Antenna tuner/earth ve MF/HF antenna", "Coast/ship DSC + voice / varsa installed NBDP", "Watch receiver, test log ve reserve power"],
  ...
  "gmdss-lsa/3": seed({
    ...
    flow: ["MMSI/IMO identity, GNSS ve message input", "Inmarsat-C/Mini-C terminal", "Satellite + land earth station", "Distress/data ve EGC MSI", "Delivery report, EGC log, self-test ve backup power"],
  ...
  "gmdss-lsa/4": seed({
    ...
    flow: ["Float-free bracket, HRU ve manual release", "406 MHz beacon + GNSS", "Cospas-Sarsat satellite/ground segment", "RCC distress data + 121.5/AIS homing", "Self-test, battery/HRU expiry ve registration"],
  ...
  "gmdss-lsa/5": seed({
    ...
    flow: ["Manual activation ve yüksek mounting", "X-band interrogation veya GNSS", "Radar SART swept response / AIS messages", "SAR radar/AIS display", "Self-test, battery expiry ve craft inventory"],
  ...
  "gmdss-lsa/6": seed({
    ...
    flow: ["Active mode + inactivity timer", "Reset devices/motion input", "Bridge visual/audible alarm", "Backup officer/master/cabin alarm stages", "Mode/reset test, defect ve bridge log"],
  ...
  "gmdss-lsa/7": seed({
    ...
    flow: ["Bridge audio, GNSS/gyro/log/AIS/alarms ve images", "Data acquisition/concentrator", "Long-term storage + fixed/float-free capsule", "Playback/export/save function", "APT, channel status ve incident preservation log"],
  ...
  "gmdss-lsa/8": seed({
    ...
    flow: ["Muster, embarkation ve securing", "Davit/winch/brake/falls", "Release gear ve painter", "Lifeboat engine/survival equipment", "Weekly/monthly checks, drills ve authorized service"],
  ...
  "gmdss-lsa/9": seed({
    ...
    flow: ["Cradle/lashing + HRU + weak link", "Float-free/manual release", "Painter pull ve CO₂ inflation", "Canopy/equipment ve embarkation", "Service date, HRU expiry, securing ve LSA record"],
  ...
  "gmdss-lsa/10": seed({
    ...
    flow: ["Assigned crew/PPE ve readiness", "Davit/winch/falls", "Release/painter ve launch", "Engine, steering ve recovery gear", "Drill, weekly/monthly check ve authorized service"],
