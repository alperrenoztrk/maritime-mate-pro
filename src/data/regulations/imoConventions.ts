...
export const imoConventions: RegulationItem[] = [
  ...
  },
  {
    ...
    amendments: [
      ...
      { year: "2005", description: "Ek I ve II kapsamlı revizyonu" },
  ...
  },
  {
    ...
    amendments: [
      { year: "2014", description: "Denizcilerin terk edilmesi durumunda finansal güvence zorunluluğu" },
      { year: "2016", description: "Taciz ve zorbalık konusunda ek koruma hükümleri" },
      { year: "2018", description: "Sözleşme kapsamının genişletilmesi tartışmaları" },
    ],
    keyArticles: [
      { id: "Title 1", title: "Asgari Gereklilikler", summary: "Asgari yaş, sağlık sertifikası, eğitim ve yeterlilik gereklilikleri." },
  ...
  },
  {
    ...
    essentials: [
      "D-2 standardı: arıtılmış balast suyu deşarjı (< 10 canlı organizma/m³)",
  ...
  },
  {
    ...
    keyArticles: [
      { id: "Part A", title: "Genel", summary: "Uygulama, sorumluluk ve genel tanımlar." },
      { id: "Part B Section I", title: "Her Koşulda Uygulanacak Kurallar", summary: "Gözcü, emniyetli hız, çatışma riski, kaçınma manevrası." },
      { id: "Part B Section II", title: "Birbirini Gören Gemiler", summary: "Yetişme, karşılaşma, çapraz geçiş ve yol verme kuralları." },
      { id: "Part B Section III", title: "Kısıtlı Görüş", summary: "Radar kullanımı, sis sinyalleri ve kısıtlı görüşte kaçınma." },
      { id: "Part C", title: "Işıklar ve Şekiller", summary: "Seyir ışıkları, güverte ışıkları ve gündüz şekilleri." },
      { id: "Part D", title: "Ses ve Işık Sinyalleri", summary: "Manevra, uyarı ve tehlike sinyalleri." },
    ],
    penalties: [
  ...
  },
  {
    ...
    history: "1969'da kabul edilen ve 1982'de yürürlüğe giren ITC 69, farklı ulusal tonaj ölçüm sistemlerini tek bir uluslararası standart altında birleştirmiştir. Geçiş süreci 1994'te tamamlanmış ve tüm uluslararası sefer yapan gemiler ITC 69'a göre ölçülmüştür.",
    applicability: [
      "Uluslararası sefer yapan 24 metre ve üzeri tüm gemiler",
      "Savaş gemileri hariç",
    ],
    essentials: ["Brüt tonaj (GT) ve net tonaj (NT) hesaplama formülleri", "Kapalı hacimlerin tanımı ve istisnaları", "Tonaj sertifikasının geçerliliği ve yenileme koşulları", "GT'nin manning, emniyet ve liman harçlarına etkisi"],
  ...
  },
  {
    ...
    history: "1979'da kabul edilen SAR Sözleşmesi, denizde arama ve kurtarma operasyonlarının uluslararası koordinasyonunu sağlamak amacıyla oluşturulmuştur. 1998'de revize edilerek operasyonel prosedürler güncellenmiştir.",
    applicability: [
      "Tüm taraf devletler ve deniz alanlarında bulunan gemiler",
      "Her boyut ve tipte deniz aracı",
    ],
    essentials: ["SRR (Search and Rescue Region) sınırları ve sorumluluklar", "MRCC/MRSC koordinasyon ve haberleşme prosedürleri", "SAR planları, tatbikatlar ve kaynak paylaşımı", "Kaptanın denizde tehlikedeki kişilere yardım yükümlülüğü"],
  ...
  },
  {
    ...
    history: "1965'te kabul edilen FAL Sözleşmesi, limanlarla ilgili bürokratik işlemleri en aza indirmek amacıyla oluşturulmuştur. 2019 değişiklikleri ile Maritime Single Window (elektronik belge sistemi) zorunluluğu getirilmiştir.",
    applicability: [
      "Uluslararası sefer yapan tüm gemiler",
      "Liman otoriteleri ve gümrük idareleri",
    ],
    essentials: ["FAL formları (1–7) ve elektronik veri değişimi", "Maritime Single Window zorunluluğu (2024'ten itibaren)", "Ön bildirim gereklilikleri ve liman prosedürleri", "Kaçak yolcu ve sığınmacı prosedürleri"],
  ...
  },
  {
    ...
    history: "1988'de Achille Lauro gemisi kaçırma olayı sonrasında kabul edilen SUA Sözleşmesi, denizde terörizm ve yasadışı eylemlere karşı hukuki çerçeve sağlamıştır. 2005 Protokolü ile kitle imha silahlarının deniz yoluyla taşınmasının önlenmesi eklenmiştir.",
    applicability: [
      "Tüm taraf devletlerin karasuları dışındaki deniz alanlarındaki gemiler",
      "Açık denizdeki sabit platformlar (Protokol ile)",
    ],
    essentials: ["Suç tanımları: gemi ele geçirme, yolcu/mürettebata şiddet, hasar verme", "Yargı yetkisi ve iade (extradition) düzenlemeleri", "2005 Protokolü: WMD taşımacılığı ve platform güvenliği", "Boarding prosedürleri ve devletlerarası işbirliği"],
