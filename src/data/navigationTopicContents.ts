...
Bu senaryoda fix güvenilirdir.`
  ...
  "GPS arızalarında uygulanacak seyir prosedürleri": {
    title: "GPS Arızalarında Uygulanacak Seyir Prosedürleri",
    introduction:
      "GPS arızası modern köprüüstünde ani ve sessiz şekilde ortaya çıkabilir. Sistem tamamen devre dışı kalabileceği gibi, daha riskli senaryoda çalışıyor görünerek hatalı konum üretmeye devam edebilir. Bu nedenle GPS arızası, teknik bir sorun olmanın ötesinde doğrudan seyir emniyeti prosedürü olarak ele alınmalıdır.",
    sections: [
      {
        title: "Arızanın Fark Edilmesi ve Konum Doğrulama",
        content: `![Image](https://pub.mdpi-res.com/drones/drones-09-00678/article_deploy/html/images/drones-09-00678-g001.png?1759054868=)

![Image](https://knowledgeofsea.com/wp-content/uploads/2020/02/439.png)

GPS kaybı fark edildiğinde ilk adım, konum bilgisinin mutlak doğruluğunu sorgulamaktır. ECDIS üzerinde gemi simgesinin seyir hattına “uyuyor” görünmesi güvenilirlik göstergesi değildir. Radar mesafeleri, radar üst üste bindirme, görsel kerterizler ve derinlik karşılaştırmaları ile konum derhal doğrulanmalıdır. Çapraz kontroller tutarsızlık gösteriyorsa, GPS verisi geçersiz kabul edilir.`
      },
      {
        title: "GPS Devre Dışı Kaldığında Seyir",
        content: `![Image](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Wind_drift.png/250px-Wind_drift.png)

![Image](https://substackcdn.com/image/fetch/w_1456%2Cc_limit%2Cf_auto%2Cq_auto%3Agood%2Cfl_progressive%3Asteep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe97cdf4e-8b05-4be5-b074-94900bf3e936_2560x1340.jpeg)

GPS tamamen devre dışı kaldığında seyir, ölü hesap prensibine döner. Son güvenilir mevkiden itibaren rota, hız ve zaman kullanılarak tahmini mevki ilerletilir. Bu süreçte hata zamanla büyür; bu nedenle pozisyon sabitleme aralıkları sıklaştırılır ve emniyet payları artırılır. Dar sularda veya trafik ayrım düzenlerinde hız düşürülmesi operasyonel olarak zorunlu hale gelir.

Köprüüstü ekip çalışması GPS arızalarında kritik rol oynar. Görev dağılımı net yapılmalı, tek bir sensöre odaklanılmamalı ve kaptan bilgilendirilmelidir. GPS’in tekrar devreye girmesi, otomatik olarak güvenilir olduğu anlamına gelmez; sistem yeniden doğrulanmalıdır.`
      },
      {
        title: "Formüller ve Örnek Hesap",
        content: `### Ölü Hesap Mesafe Hesabı

Mesafe = Hız × Zaman

### Tahmini Mevki İlerletme Mantığı

Yeni mevki = Son güvenilir mevki + Ölü hesap mesafesi ve rota

### Hata Büyüme Yaklaşımı

Toplam tahmini hata ≈ Önceki hata + Seyir süresi × Hız belirsizliği
...
**Adım 1: Zamanın saat cinsine çevrilmesi**  
30 dakika = 0,5 saat

**Adım 2: Kat edilen mesafenin hesaplanması**  
Mesafe = 12 × 0,5  
Mesafe = 6 deniz mili

**Adım 3: Tahmini mevkinin belirlenmesi**  
Son güvenilir mevkiden itibaren rota doğrultusunda 6 deniz mili ilerlenir.

**Adım 4: Operasyonel değerlendirme**  
Bu mevki yalnızca tahminidir. Radar mesafesi veya görsel kerteriz elde edilmeden emniyetli kabul edilemez.`
      }
    ],
    keyPoints: [
      "GPS arızası şüphesinde konum, radar ve görsel kerterizlerle derhal doğrulanmalıdır.",
      "Ölü hesap, GPS kaybında temel yöntemdir; hata zamanla büyür.",
      "Dar sularda hız düşürme ve emniyet paylarını artırma zorunludur.",
      "GPS geri geldiğinde otomatik güvenilmez; yeniden doğrulama şarttır."
    ]
  },
};
