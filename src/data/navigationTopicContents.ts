...
Kurs–mesafe hesapları, düzlem seyirde hareketi bir dik üçgen olarak ele alır. Hipotenüs seyredilen mesafe, dik kenarlar ise **DLat** ve **departure** bileşenleridir. Bu yöntem, kısa mesafelerde ve orta enlemlerde pratik ve güvenilir sonuç verir.`
      },
      {
...
İşaret, kursun hangi çeyrekte olduğuna göre belirlenir. 0°–180° aralığı kuzey bileşeni, 180°–360° aralığı güney bileşeni üretir. 0°–180° içinde sin pozitif olduğundan doğu bileşeni çıkar, 180°–360° içinde sin negatifleştiği için batı bileşeni çıkar.
...
DLong dakika boylam, doğrudan deniz mili değildir. Boylam dakikasının gerçek uzunluğu enleme bağlıdır. Düzlem seyirde bunun için orta enlem kullanılır.

Orta Enlem = (Başlangıç Enlemi + Varış Enlemi) ÷ 2

Departure = DLong × cos Orta Enlem

Burada DLong dakika cinsinden alınır; sonuç deniz mili çıkar. Cos değeri orta enlemin derecesine göre alınır.
...
Tan θ bağıntısı yalnız açının büyüklüğünü verir; hangi yönde olduğuna DLat ve departure karar verir. Bu yüzden kurs çözümünde önce DLat’in kuzey mi güney mi olduğu, departure’ın doğu mu batı mı olduğu netleştirilir. Ardından bulunan açı uygun çeyreğe yerleştirilir. Bu disiplin uygulanmadan yapılan kurs hesapları, sayısal olarak doğru açı üretse bile 180° hatayla yanlış yöne yerleşebilir.`
    ...
    keyPoints: [
      ...
      "DLat kuzeye pozitif, güneye negatif; departure doğuya pozitif, batıya negatiftir",
      "DLat = Mesafe × cos(Kurs), Departure = Mesafe × sin(Kurs)",
      "Kurs çözümünde çeyrek belirleme, 180° hata riskini ortadan kaldırır"
    ]
  },
  "Boylam": {
...
Harita ölçeği, tek başına seyri güvenli hâle getirmez; ancak yanlış ölçek seçimi, doğru hesapları bile tehlikeli kılar. Marine Expert içinde bu konu, yalnızca “büyük–küçük ölçek” tanımıyla geçiştirilirse kullanıcı, liman yaklaşımını kıyı haritasıyla yönetmeye çalışır veya küçük ölçekli haritada görünmeyen tehlikeyi yok sanır. Bu nedenle ölçek, tanım olarak değil; **hangi safhada hangi harita ile karar verileceğini öğreten bir refleks** olarak sunulmalıdır. Bu refleks oluştuğunda harita, pasif bir çizim değil, aktif bir seyir aracı hâline gelir.`
  ...
  "Mercator projeksiyonu": {
    ...
    sections: [
      {
        title: "Mercator Projeksiyonun Temeli",
...
![Mercator projeksiyon ve dünya modeli](https://cdn.britannica.com/55/109155-050-9FE4B08C/simple-cylindrical-projection-earth-map-globe-mercator.jpg)

![Mercator projeksiyonun enlem açılması](https://www.math.ubc.ca/~israel/m103/mercator.png)

![Mercator projeksiyon seyir şeması](https://sailingissues.com/chart-symbols/mercator-projection-navigation-course-3x.png)`
      },
      {
...
![Mercator projeksiyon geometri örneği](https://cdn.britannica.com/55/109155-050-9FE4B08C/simple-cylindrical-projection-earth-map-globe-mercator.jpg)

![Mercator projeksiyon enlem aralıkları](https://www.math.ubc.ca/~israel/m103/mercator.png)`
      },
      {
...
![Loxodrome çizgileri](https://gisgeography.com/wp-content/uploads/2016/11/RhumbLine-Loxodrome-Mercator.jpg)

![Mercator üzerinde rhumb line örnekleri](https://www.researchgate.net/publication/268872013/figure/fig3/AS%3A392212723585029%401470522208424/The-Mercator-map-projection-The-rhumb-lines-show-as-straight-lines.png)`
      },
      {
...
![Mercator mesafe ölçekleme örneği](https://i.sstatic.net/Oh0ob.jpg)

![Deniz mili tanımı](https://easysextant.com/wp-content/uploads/2024/08/definition-mile.jpg.webp)`
      },
      {
...
![Mercator projeksiyonda alan bozulması](https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Mercator_projection_Square.JPG/1200px-Mercator_projection_Square.JPG)

![Greenland örneği](https://www.geospatialworld.net/wp-content/uploads/2017/05/Greenland_1.jpg)`
      },
      {
...
![Mercator projeksiyon bozulma örneği](https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Mercator_projection_Square.JPG/1200px-Mercator_projection_Square.JPG)

![Mercator projeksiyon yakın kutup örneği](https://upload.wikimedia.org/wikipedia/commons/7/73/Mercator_projection_Square.JPG)`
      },
      {
...
![Mercator projeksiyon seyir örneği](https://sailingissues.com/chart-symbols/mercator-projection-navigation-course-3x.png)

![Rota hesap şeması](https://sidaerum.com/wp-content/uploads/2023/02/FRM-62_3.png)`
      }
    ],
    keyPoints: [
      "Mercator projeksiyon yön ve doğrultu ilişkilerini korur",
      "Loxodrome çizgileri Mercator haritada düz görünür",
      "Mesafe ölçümü yalnızca enlem skalası üzerinden yapılır",
      "Yüksek enlemlerde alan ve ölçek bozulması büyür",
      "Klasik seyir hesapları Mercator varsayımıyla yürütülür"
    ]
  },
  "Harita ölçeği": {
    title: "Harita Ölçeği",
