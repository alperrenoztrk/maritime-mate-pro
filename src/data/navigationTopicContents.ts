...
![Kesişim türleri ve hata etkisi](https://www.researchgate.net/publication/352523373/figure/fig1/AS%3A1038230812102656%401624544923281/Different-types-of-intersections.png)`
  ...
  "Intercept yöntemi": {
    title: "Intercept Yöntemi (Marcq Saint-Hilaire)",
    introduction:
      "Intercept yöntemi, göksel seyirde en yaygın kullanılan mevki tayini tekniğidir. Varsayılan mevki (AP) üzerinden hesaplanan teorik yükseklik (Hc) ile sextant ile ölçülüp düzeltilen gözlemsel yükseklik (Ho) arasındaki fark kullanılarak mevki hattı (LOP) çizilir. Bu farka intercept denir ve doğrudan deniz mili cinsinden uzaklık verir.",
    sections: [
      {
        title: "Görsel Referanslar",
        content: `![Intercept geometrisi temel](https://www.myseatime.com/blogadm/wp-content/uploads/2018/03/Position-line-from-intercept-method-concept.jpg)

![Intercept yöntem şeması](https://flyandwire.com/wp-content/uploads/2020/12/intercept-geometry-n-p2-definitions-rate-of-closure-tid-as-2.png?w=780)

![Toward ve away kavramı](https://easysextant.com/wp-content/uploads/2024/05/towards-or-away-from-the-sun-677x1024.jpg.webp)

![LOP ve intercept ilişkisi](https://astronavigationdemystified.com/wp-content/uploads/2012/06/diag-16-mod.jpg?w=584)`
      },
      {
        title: "Aşama 1: Varsayılan Mevkinin Belirlenmesi (AP)",
        content:
          "Varsayılan mevki (Assumed Position – AP), DR mevkiine yakın seçilen referans noktadır. Hesaplama kolaylığı için genellikle tam derece enlem ve tam dakika boylam olarak yuvarlanır. Bu nokta üzerinden Hc ve Zn hesaplanır. AP, geometrik referans noktasıdır; doğru mevki değildir."
      },
      {
        title: "Aşama 2: Teorik Yüksekliğin Hesaplanması (Hc)",
        content:
          "AP enlemi (φ), gök cisminin deklinasyonu (δ) ve yerel saat açısı (LHA) kullanılarak Hc bulunur. Pratikte Sight Reduction Tables (HO-249, HO-229) veya hesap makinesi ile elde edilir.",
        formula: {
          text: "sin Hc = sin φ × sin δ + cos φ × cos δ × cos LHA",
          description: "Hc: hesaplanan yükseklik | φ: enlem | δ: deklinasyon | LHA: yerel saat açısı"
        }
      },
      {
        title: "Aşama 3: Intercept Hesabı",
        content:
          "Intercept, gözlenen yükseklik (Ho) ile hesaplanan yükseklik (Hc) arasındaki farkın deniz miline dönüştürülmesidir. 1 dakika yükseklik farkı = 1 deniz mili.",
        formula: {
          text: "a = Ho − Hc",
          description: "a: intercept (NM) | 1′ fark = 1 NM"
        }
      },
      {
        title: "Aşama 4: Yön Belirleme (Toward / Away)",
        content:
          "Intercept yönü, Ho ve Hc karşılaştırmasıyla belirlenir:\n\n" +
          "• **Ho > Hc** → Gemi, varsayılan mevkiden gök cismine **daha yakındır** → **Toward**\n" +
          "• **Ho < Hc** → Gemi, varsayılan mevkiden gök cismine **daha uzaktadır** → **Away**\n\n" +
          "Bu yön bilgisi, azimut (Zn) doğrultusunda intercept mesafesinin hangi yönde taşınacağını belirler."
      },
      {
        title: "Aşama 5: LOP Çizimi",
        content:
          "AP noktasından Zn doğrultusunda intercept mesafesi kadar ilerlenir (toward ise gök cismine doğru, away ise ters yöne). Bu noktadan Zn'ye dik bir doğru çizilir. Bu doğru LOP'tur.",
        formula: {
          text: "LOP = Zn ± 90°",
          description: "LOP, azimut doğrultusuna dik çizilir."
        }
      },
      {
        title: "Sayısal Örnek",
        content: `**Verilenler:**
• Varsayılan mevki: 35° N, 020° W
• Hc = 42° 15.0′
• Ho = 42° 21.5′
• Zn = 135°

**Intercept hesabı:**
a = Ho − Hc = 42° 21.5′ − 42° 15.0′ = **6.5′** = **6.5 NM**

**Yön:**
Ho > Hc → **Toward** (gök cismine doğru)

**LOP çizimi:**
AP'den 135° doğrultusunda 6.5 NM ilerle → Bu noktadan 135° ± 90° = **045°** veya **225°** doğrultusunda LOP çiz.`
      }
    ],
    keyPoints: [
      "Intercept = Ho − Hc formülü ile bulunur; 1′ fark = 1 NM.",
      "Ho > Hc ise toward (gök cismine doğru), Ho < Hc ise away (uzağa).",
      "LOP, azimut doğrultusuna dik çizilir.",
      "Varsayılan mevki gerçek mevkiye yakın seçilmelidir."
    ]
  },
  "Öğle mevkii (enlem)": {
    title: "Öğle Mevkii (Mer Pass – Meridian Passage)",
    introduction:
      "Öğle mevkii, Güneş'in gözlemcinin meridyeninden geçtiği an (meridian passage) yapılan gözlemle enlemi doğrudan bulmaya dayanan klasik göksel seyir yöntemidir. Bu anda Güneş'in yüksekliği maksimum olur ve azimut tam kuzey (000°) veya tam güney (180°) olur. Bu basit geometri, enlem hesabını doğrudan ve intercept yöntemi olmaksızın mümkün kılar.",
    sections: [
      {
        title: "Görsel Referanslar",
        content: `![Meridian passage geometrisi](https://astronavigationdemystified.com/wp-content/uploads/2015/07/noon-lat-pic-1.jpg)

![Öğle mevkii şeması](https://www.sailingissues.com/drie/celestial-navigation-altitude-declination-latitude.png)

![Güneş meridyen geçişi](https://earthsky.org/upl/2019/08/sun-at-local-solar-noon-e1565977161508.jpg)

![Enlem – deklinasyon – zenit uzaklığı](https://astronavigationdemystified.com/wp-content/uploads/2017/10/diag4-with-greenwich.jpg?w=584)`
      },
      {
        title: "Temel Prensip",
        content:
          "Güneş meridyenden geçerken, gözlemci ile Güneş'in coğrafi noktası (GP) aynı meridyen üzerindedir. Bu durumda LHA = 0° olur ve azimut ya 000° (kuzey yarımkürede, Güneş güneyde) ya da 180° (güney yarımkürede, Güneş kuzeyde) olur. Bu basit geometri, enlem hesabını doğrudan mümkün kılar."
      },
      {
        title: "Zenit Uzaklığı ve Enlem İlişkisi",
        content:
          "Güneş meridyendeyken, gözlemcinin enlemi (φ) ile Güneş'in deklinasyonu (δ) ve zenit uzaklığı (Z) arasında doğrudan bir ilişki vardır.",
        formula: {
          text: "φ = δ ± Z",
          description: "φ: enlem | δ: Güneş deklinasyonu | Z: zenit uzaklığı = 90° − Ho"
        }
      },
      {
        title: "İşaret Kuralları",
        content:
          "**Aynı yarımküre** (gözlemci ve Güneş aynı tarafta):\n" +
          "• **φ = Z + δ** (Güneş güneyde ise)\n" +
          "• **φ = Z − δ** (Güneş kuzeyde ise)\n\n" +
          "**Farklı yarımküre** (gözlemci ve Güneş karşı taraflarda):\n" +
          "• **φ = Z − δ** ve işaret kontrol edilir.\n\n" +
          "Pratik kural: Güneş'in azimutuna bakarak hangi formülün kullanılacağı belirlenir."
      },
      {
        title: "Gözlem Prosedürü",
        content:
          "1. Güneş'in meridyen geçiş zamanı önceden hesaplanır (yaklaşık 1200 yerel zaman).\n" +
          "2. Güneş yaklaşırken sextant ile yükseklik takibi başlar.\n" +
          "3. Yükseklik maksimum değere ulaşıp düşmeye başladığı an not edilir.\n" +
          "4. Maksimum yükseklik değeri alınır ve düzeltmeler uygulanır → Ho.\n" +
          "5. Zenit uzaklığı hesaplanır: Z = 90° − Ho.\n" +
          "6. Almanaktan deklinasyon (δ) okunur.\n" +
          "7. Enlem formülü uygulanır."
      },
      {
        title: "Sayısal Örnek",
        content: `**Verilenler:**
• Maksimum Güneş yüksekliği (düzeltilmiş): Ho = 72° 15.0′
• Güneş deklinasyonu: δ = 15° 30.0′ N
• Gözlemci kuzey yarımkürede, Güneş güneyde

**Zenit uzaklığı:**
Z = 90° − 72° 15.0′ = **17° 45.0′**

**Enlem hesabı:**
φ = Z + δ = 17° 45.0′ + 15° 30.0′ = **33° 15.0′ N**

Gemi **33° 15.0′ Kuzey** enlemindedir.`
      },
      {
        title: "Avantajlar ve Sınırlamalar",
        content:
          "**Avantajlar:**\n" +
          "• Intercept hesabı gerekmez.\n" +
          "• Azimut hesabı gerekmez (otomatik olarak 000° veya 180°).\n" +
          "• Tek gözlemle enlem bulunur.\n\n" +
          "**Sınırlamalar:**\n" +
          "• Sadece meridyen geçişinde geçerlidir.\n" +
          "• Boylam bilgisi vermez.\n" +
          "• Bulutlu havada gözlem yapılamaz."
      }
    ],
    keyPoints: [
      "Güneş meridyenden geçerken maksimum yüksekliğe ulaşır.",
      "Zenit uzaklığı Z = 90° − Ho ile bulunur.",
      "Enlem, deklinasyon ve zenit uzaklığından doğrudan hesaplanır.",
      "Intercept veya azimut hesabı gerektirmeyen basit bir yöntemdir."
    ]
  },
  "Zamanla boylam": {
    title: "Zamanla Boylam Tayini (Longitude by Chronometer)",
    introduction:
      "Zamanla boylam tayini, gözlem anının Greenwich zamanı (UTC) ile yerel zamanı arasındaki farkın doğrudan boylama dönüştürülmesine dayanır. Dünya 24 saatte 360° döndüğü için zaman farkı doğrudan açısal farka eşittir. Bu yöntem, göksel seyirde boylam bulmanın temel prensibini oluşturur.",
    sections: [
      {
        title: "Görsel Referanslar",
        content: `![Zaman ve boylam ilişkisi](https://www.thestargarden.co.uk/Images/Longitude-time-zones.jpg)

![Greenwich ve yerel meridyen](https://astronavigationdemystified.com/wp-content/uploads/2017/10/diag4-with-greenwich.jpg?w=584)

![Boylam – zaman dönüşümü](https://www.eso.org/public/outreach/eduoff/seaspace/navigation/navastro/images/nava13a.gif)

![Kronometre ve seyir](https://astronavigationdemystified.com/wp-content/uploads/2015/07/gmt-white.jpg)`
      },
      {
        title: "Temel İlişki",
        content:
          "Dünya'nın dönüş hızı sabit olduğundan, zaman ile açı arasında doğrudan dönüşüm yapılabilir:",
        formula: {
          text: "15° = 1 saat | 1° = 4 dakika | 1′ = 4 saniye",
          description: "Zaman – açı dönüşümünün temel bağıntıları"
        }
      },
      {
        title: "Boylam Formülü",
        content:
          "Gözlem anındaki Greenwich zamanı (UTC) ile yerel zaman arasındaki fark, doğrudan boylama dönüştürülür:",
        formula: {
          text: "λ = (LMT − UTC) × 15°",
          description: "λ: boylam | LMT: yerel ortalama zaman | UTC: Greenwich zamanı"
        }
      },
      {
        title: "Yön Belirleme",
        content:
          "**Yerel zaman > UTC** → Gözlemci **doğu** boylamındadır.\n\n" +
          "**Yerel zaman < UTC** → Gözlemci **batı** boylamındadır.\n\n" +
          "Bu kural, zaman farkının işaretini belirler ve boylamın doğu/batı olarak ifade edilmesini sağlar."
      },
      {
        title: "Göksel Seyirde Uygulama",
        content:
          "Pratikte yerel zaman doğrudan okunamaz. Bunun yerine gök cisminin LHA değeri üzerinden çalışılır:\n\n" +
          "1. Gözlem anında UTC kronometreden okunur.\n" +
          "2. Almanaktan GHA (Greenwich Hour Angle) bulunur.\n" +
          "3. Sight Reduction ile LHA hesaplanır.\n" +
          "4. **λ = GHA − LHA** (veya tersi) bağıntısı ile boylam elde edilir.",
        formula: {
          text: "λ = GHA ± LHA",
          description: "Boylam, GHA ve LHA arasındaki farktan bulunur."
        }
      },
      {
        title: "Sayısal Örnek",
        content: `**Verilenler:**
• Yerel öğle zamanında kronometre okuması: 15:24:00 UTC
• Yerel öğle = 12:00:00 LMT (varsayım)

**Zaman farkı:**
Δt = 12:00:00 − 15:24:00 = **−3 saat 24 dakika**
...
Yerel zaman UTC'den geri olduğu için gemi **batı** boylamındadır.`
      },
      {
        title: "Kronometre Hatası",
        content:
          "Kronometre hataları doğrudan boylam hatasına dönüşür:\n\n" +
          "• 1 saniye zaman hatası ≈ 0.25′ boylam hatası\n" +
          "• 4 saniye zaman hatası ≈ 1 NM hata (ekvatorda)\n\n" +
          "Bu nedenle kronometrenin düzenli kontrolü ve hata kaydı (rate) kritik önemdedir."
      }
    ],
    keyPoints: [
      "15° boylam = 1 saat zaman farkı temel dönüşüm ilişkisidir.",
      "Yerel zaman UTC'den ileri ise doğu, geri ise batı boylamı.",
      "Boylam, GHA ve LHA arasındaki farktan hesaplanır.",
      "Kronometre hataları doğrudan boylam hatasına dönüşür."
    ]
  },
  "Running fix (göksel)": {
    title: "Running Fix (Göksel Seyir)",
    introduction:
      "Göksel seyirde running fix, farklı zamanlarda alınan gök cismi gözlemlerinin birleştirilmesiyle mevki tayini yapılmasıdır. İlk gözlemden elde edilen LOP, geminin hareketi kadar taşınarak ikinci gözlemin LOP'u ile kesiştirilir. Bu yöntem, tek bir gök cismi veya farklı gök cisimleri kullanılarak uygulanabilir.",
    sections: [
      {
        title: "Görsel Referanslar",
        content: `![Running fix göksel seyir](https://www.onboardintelligence.com/CelestialNav/Images/InFix.jpg)

![LOP taşıma kavramı](https://astronavigationdemystified.com/wp-content/uploads/2012/07/diag-36-running-fix.jpg?w=584)

![Göksel running fix geometrisi](https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Diagram_showing_GP_distance_%3D_ZD.jpg/500px-Diagram_showing_GP_distance_%3D_ZD.jpg)`
      },
      {
        title: "Temel Prensip",
        content:
          "Running fix'in mantığı klasik (terrestrial) seyirdeki ile aynıdır: İlk LOP, geminin hareket miktarı kadar taşınır ve ikinci LOP ile kesiştirilir. Taşıma mesafesi ve doğrultusu, geminin rotası ve hızından hesaplanır."
      },
      {
        title: "Uygulama Adımları",
        content:
          "1. **Birinci gözlem** yapılır, UTC zamanı not edilir.\n" +
          "2. Intercept yöntemiyle **LOP₁** çizilir.\n" +
          "3. Belirli bir süre sonra **ikinci gözlem** yapılır.\n" +
          "4. **Zaman farkı** hesaplanır: Δt = t₂ − t₁\n" +
          "5. **Taşıma mesafesi** hesaplanır: Δs = V × Δt\n" +
          "6. LOP₁, geminin rotası doğrultusunda Δs kadar **paralel taşınır**.\n" +
          "7. **LOP₂** çizilir.\n" +
          "8. Taşınmış LOP₁ ve LOP₂'nin kesişimi → **Running Fix**"
      },
      {
        title: "Taşıma Formülü",
        content:
          "LOP taşıma mesafesi, hız ve zaman farkından hesaplanır:",
        formula: {
          text: "Δs = V × Δt",
          description: "Δs: taşıma mesafesi (NM) | V: hız (knot) | Δt: zaman farkı (saat)"
        }
      },
      {
        title: "Aynı veya Farklı Gök Cisimleri",
        content:
          "Running fix şu kombinasyonlarla yapılabilir:\n\n" +
          "• **Aynı cisim, farklı zamanlar:** Güneş sabah ve öğlen gözlemleri.\n" +
          "• **Farklı cisimler:** Bir yıldız ve Ay; veya iki farklı yıldız.\n\n" +
          "Farklı cisimlerin azimutları arasında yeterli açı farkı olması (ideal: 60°–120°) fix güvenilirliğini artırır."
      },
      {
        title: "Sayısal Örnek",
        content: `**Verilenler:**
• Birinci gözlem: 08:00 UTC, LOP₁ çizildi
• İkinci gözlem: 10:30 UTC, LOP₂ çizildi
• Gemi rotası: 090°T
• Gemi hızı: 12 knot

**Zaman farkı:**
Δt = 10:30 − 08:00 = **2.5 saat**

**Taşıma mesafesi:**
Δs = 12 × 2.5 = **30 NM**

**İşlem:**
LOP₁, 090° doğrultusunda 30 NM taşınır.
Taşınmış LOP₁ ile LOP₂'nin kesişimi **10:30 UTC running fix**'idir.`
      },
      {
        title: "Hata Kaynakları",
        content:
          "• Hız veya rota değişimlerinin dikkate alınmaması\n" +
          "• Akıntı ve leeway'in ihmal edilmesi\n" +
          "• Zaman kayıt hataları\n" +
          "• LOP'ların paralel olmayan taşınması\n\n" +
          "Running fix, DR bilgisine bağımlıdır; DR'deki hatalar fix'e yansır."
      }
    ],
    keyPoints: [
      "İlk LOP, geminin hareketi kadar paralel taşınır.",
      "Taşıma mesafesi Δs = V × Δt formülüyle hesaplanır.",
      "Taşınmış LOP ile ikinci LOP'un kesişimi running fix'i verir.",
      "DR hataları running fix'in güvenilirliğini doğrudan etkiler."
    ]
  },
  "Göksel seyir hata analizi": {
    title: "Göksel Seyir Hata Analizi",
    introduction:
      "Göksel seyirde her ölçüm ve hesaplama adımında sistematik veya rastgele hatalar oluşabilir. Bu hataların kaynağının bilinmesi, etkisinin minimize edilmesi ve sonuçların güvenilirlik değerlendirmesi, fix kalitesini doğrudan belirler. Hata analizi, göksel seyirin matematiksel doğruluğunu pratik güvenilirliğe dönüştüren kritik bir aşamadır.",
    sections: [
      {
        title: "Hata Kaynakları ve Sınıflandırma",
        content:
          "Göksel seyirde hatalar üç ana kategoride incelenir:\n\n" +
          "**1. Alet Hataları (Instrumental Errors)**\n" +
          "• İndeks hatası (Index Error)\n" +
          "• Sextant mekanik kusurları\n" +
          "• Ayna ayar bozuklukları\n\n" +
          "**2. Kişisel Hatalar (Personal Errors)**\n" +
          "• Ufuk-cisim çakıştırma hatası\n" +
          "• Zaman okuma gecikmesi\n" +
          "• Gözlem açısı tutarsızlığı\n\n" +
          "**3. Çevresel Hatalar (Environmental Errors)**\n" +
          "• Anormal refraksiyon\n" +
          "• Sıcaklık ve basınç etkileri\n" +
          "• Ufuk belirsizliği (haze, dalga)"
      },
      {
        title: "Zaman Hataları ve Boylam Etkisi",
        content:
          "Kronometre hataları doğrudan boylam hatasına dönüşür:\n\n" +
          "• **1 saniye zaman hatası ≈ 0.25′ boylam hatası**\n" +
          "• **4 saniye zaman hatası ≈ 1 NM hata** (ekvatorda)\n" +
          "• Yüksek enlemlerde etki azalır\n\n" +
          "Zaman kaydı, göksel seyirde en kritik hata kaynağıdır.",
        formula: {
          text: "Boylam hatası ≈ Δt (saniye) × 0.25′",
          description: "Zaman hatası doğrudan boylam hatasına dönüşür."
        }
      },
      {
        title: "Yükseklik Düzeltme Hataları",
        content:
          "Her düzeltme aşamasında hata birikebilir:\n\n" +
          "**Dip düzeltmesi:**\n" +
          "• Göz yüksekliği tahmin hatası\n" +
          "• Dalga etkisi\n\n" +
          "**Refraksiyon:**\n" +
          "• Standart koşul varsayımı\n" +
          "• Düşük yüksekliklerde büyük belirsizlik\n\n" +
          "**SD ve Paralaks:**\n" +
          "• Almanaktan yanlış okuma\n" +
          "• Ay gözlemlerinde yüksek hassasiyet gereksinimi"
      },
      {
        title: "Düşük Yükseklik Gözlemleri",
        content:
          "Yükseklik 15°'nin altında olduğunda refraksiyon hataları katlanarak artar:\n\n" +
          "• **10° yükseklikte** refraksiyon ≈ 5.3′\n" +
          "• **5° yükseklikte** refraksiyon ≈ 10′\n" +
          "• **Ufuk yakınında** refraksiyon > 30′\n\n" +
          "**Pratik kural:** 15°'nin altındaki gözlemlerden kaçınılmalıdır.",
        formula: {
          text: "R ≈ 1 / tan h (dakika)",
          description: "Düşük yüksekliklerde refraksiyon hızla artar."
        }
      },
      {
        title: "Cocked Hat ve Fix Güvenilirliği",
        content:
          "Üç LOP'un kesişiminde oluşan üçgen (cocked hat), hata büyüklüğünü görsel olarak gösterir:\n\n" +
          "• **Küçük cocked hat (< 2 NM):** Güvenilir fix\n" +
          "• **Orta cocked hat (2-5 NM):** Kabul edilebilir\n" +
          "• **Büyük cocked hat (> 5 NM):** Sistematik hata var\n\n" +
          "Büyük cocked hat durumunda gözlemler tekrar değerlendirilmelidir."
      },
      {
        title: "Hata Azaltma Stratejileri",
        content:
          "**Gözlem aşamasında:**\n" +
          "• Birden fazla gözlem yapıp ortalama al\n" +
          "• İndeks hatasını her gözlem öncesi kontrol et\n" +
          "• Düşük yüksekliklerden kaçın\n\n" +
          "**Hesaplama aşamasında:**\n" +
          "• Almanaktan dikkatli oku\n" +
          "• İnterpolasyonu doğru uygula\n" +
          "• Tablo sayfalarını kontrol et\n\n" +
          "**Fix değerlendirmesinde:**\n" +
          "• 3 LOP kullan (cocked hat kontrolü)\n" +
          "• DR ile tutarlılığı kontrol et\n" +
          "• Şüpheli durumda gözlemi tekrarla"
      },
      {
        title: "Sayısal Hata Özeti",
        content: `| Hata Kaynağı | Tipik Etki |
|--------------|------------|
| 1° sextant okuma hatası | ~1 NM fix hatası |
| 1 saniye zaman hatası | ~0.25′ boylam hatası |
| 1°C sıcaklık farkı | ~0.1′ refraksiyon hatası |
| 10 mbar basınç farkı | ~0.5′ refraksiyon hatası |
| 1 metre göz yüksekliği hatası | ~0.3′ dip hatası |`
      }
    ],
    keyPoints: [
      "Hatalar alet, kişisel ve çevresel olarak üç kategoride incelenir.",
      "Zaman hataları doğrudan boylam hatasına dönüşür (1s ≈ 0.25′).",
      "Düşük yüksekliklerde (< 15°) refraksiyon hataları çok büyüktür.",
      "Cocked hat boyutu, fix güvenilirliğinin görsel göstergesidir.",
      "Birden fazla gözlem ve 3 LOP kullanımı hata kontrolünü artırır."
    ]
  }
};
