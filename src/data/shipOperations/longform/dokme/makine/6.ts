...
const content: ShipOpLongForm = {
  title: "Ballast su arıtma sistemi (BWTS) operasyonu ve kayıt",
  shipType: "dokme",
  dept: "makine",
  opIndex: 6,
  estimatedPages: 14,
      ...
      sections: [
        {
          ...
          paragraphs: [
            `Pre-flow testi sonrası TRO/UV doz izlenir; ballast/deballast sırasında aktif çalışır ve BWRB'ye kaydedilir. Yüksek ballast debisinde sistem kapasitesi kritiktir.`,
          ],
