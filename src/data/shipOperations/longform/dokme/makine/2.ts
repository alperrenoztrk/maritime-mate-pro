...
const content: ShipOpLongForm = {
  ...
  opIndex: 2,
  estimatedPages: 18,
  intro: `Bunker; pre-bunker toplantısı, safety checklist, kontrollü rate, mühürlü numune ve BDN disiplinini gerektirir. Dökülme ve yanlış miktar başlıca risklerdir. Bu bölüm bunker operasyonunu ele alır.`,
      ...
      sections: [
        {
          ...
          paragraphs: [
            `Pre-bunker meeting yapılır; scupper plug ve SOPEP hazır. İlk akış yavaş, topping-up el ile. Tank ullage'leri izlenir.`,
          ],
      ...
      sections: [
        {
          ...
          paragraphs: [
            `Mühürlü MARPOL numunesi alınır ve saklanır; BDN doğrulanır, deftere işlenir. Kükürt içeriği kullanım bölgesine uygun olmalıdır.`,
          ],
          callouts: [
