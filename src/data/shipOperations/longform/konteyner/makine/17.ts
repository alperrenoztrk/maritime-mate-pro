      ...
      sections: [
        {
          ...
          paragraphs: [
            `Limandan ayrılmadan önce (12 saat içinde) main steering test edilir; emergency steering ve haberleşme en az üç ayda bir yapılan acil dümen tatbikatıyla doğrulanır (SOLAS V/26.4). Hidrolik yağ temizliği izlenir.`,
          ],
