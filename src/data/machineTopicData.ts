...
export const machineTopics: MachineTopicConfig[] = [
  ...
  { slug: "maintenance", title: "Bakım ve Tutum", icon: HardHat, accent: "from-stone-500 via-amber-600 to-yellow-600" },
  { slug: "engine-room-safety", title: "Makine Dairesi Güvenliği", icon: ShieldAlert, accent: "from-rose-500 via-red-500 to-orange-500" },
  { slug: "environment-machine", title: "Çevre ve MARPOL – Makine", icon: Leaf, accent: "from-green-500 via-emerald-500 to-teal-500" },
  { slug: "erm", title: "Engine Resource Management", icon: Users, accent: "from-indigo-500 via-blue-500 to-cyan-500" },
