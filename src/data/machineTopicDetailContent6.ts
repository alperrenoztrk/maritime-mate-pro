  ...
  "fuel-technology": {
    ...
    "Yoğunluk ve API gravity": {
      ...
      sections: [
        ...
        { heading: "API Gravity", paragraphs: ["API gravity, Amerikan Petrol Enstitüsü tarafından tanımlanan ters yoğunluk ölçeğidir. Hafif yakıtlar yüksek API değerine sahiptir."], formula: { expression: "API = (141.5 / SG₆₀°F) − 131.5", variables: ["SG₆₀°F: 60°F'deki (15.56°C) spesifik gravity"] }, example: { problem: "Yoğunluğu 15°C'de 960 kg/m³ olan bir HFO'nun API gravity değerini hesaplayınız.", steps: ["SG = 960 / 999.1 = 0.9609", "API = 141.5 / 0.9609 − 131.5", "API = 147.3 − 131.5 = 15.8"], result: "API gravity value is 15.8 (heavy fuel)." } }
      ],
    ...
    "Yakıt değiştirme (fuel changeover) prosedürü": {
      ...
      sections: [
        ...
        { heading: "Dikkat Edilecek Noktalar", paragraphs: ["Hızlı sıcaklık değişimi yakıt pompası ve enjeksiyon sistemi contalarına zarar verebilir. Sıcaklık değişim hızı tipik olarak dakikada en fazla 2°C (2°C/dakika) olmalıdır.", "MGO'nun yağlama özelliği HFO'dan düşüktür; bazı motorlarda yağlama katkısı gerekebilir.", "MARPOL gereği changeover prosedürü ve kaydı zorunludur."] }
      ],
    ...
    "Bunker miktarı ölçüm yöntemleri": {
      ...
      sections: [
        ...
        { heading: "Hacim-Kütle Dönüşümü", paragraphs: ["Ölçülen hacim, yakıtın ölçüm sıcaklığındaki yoğunluğu ile çarpılarak kütleye (metrik ton) dönüştürülür. Sıcaklık düzeltmesi ASTM/IP tablolarına göre yapılır."], formula: { expression: "Mass (mt) = Volume (m³) × ρf (kg/m³) / 1000", variables: ["ρt: Ölçüm sıcaklığındaki yoğunluk"] } }
      ],
