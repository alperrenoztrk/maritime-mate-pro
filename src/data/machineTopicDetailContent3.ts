...
const content3: ContentMap = {
  ...
  "cooling-hvac": {
    ...
    "COP (Performans Katsayısı) hesabı": {
      ...
      sections: [
        { heading: "COP Hesabı", paragraphs: ["Soğutma COP'u, evaporatörde alınan ısının kompresör tarafından harcanan iş enerjisine oranıdır. Isı pompası COP'u ise kondenserde atılan ısının kompresör işine oranıdır."], formula: { expression: "COPsoğutma = Qevaporatör / Wkompresör = (h₁ − h₄) / (h₂ − h₁)\nCOPısıpompası = COPsoğutma + 1", variables: ["Qevap: Soğutma kapasitesi (kW)", "Wkomp: Kompresör gücü (kW)"] }, example: { problem: "Bir gemi provizyon soğutma sisteminde evaporatörde 50 kW ısı alınıyor ve kompresör 18 kW güç tüketiyor. COP değerini hesaplayınız.", steps: ["COP = Qevap / Wkomp = 50 / 18 = 2.78"], result: "COP = 2.78, yani harcanan her 1 kW elektrik enerjisi karşılığında 2.78 kW soğutma etkisi elde edilmektedir." } }
      ],
