...
const topicQuestions: Record<string, QuizQuestion[]> = {
  thermodynamics: [
    { id: 1, question: "What parameters does the efficiency of the Carnot cycle depend on?", options: ["Pressure only", "Hot and cold source temperatures", "Volume and pressure", "Fluid type"], correctAnswer: 1, explanation: "Carnot efficiency depends only on source temperatures with the formula η = 1 − TL/TH.", category: "Thermodynamics" },
  ...
  "environment-machine": [
    ...
    { id: 4, question: "On which ships is IAPP certification mandatory?", options: ["On all ships", "On ships over 400 GT", "On tankers only", "On cruise ships only"], correctAnswer: 1, explanation: "IAPP (International Air Pollution Prevention) certificate is mandatory for ships operating internationally over 400 GT.", category: "Environment" },
