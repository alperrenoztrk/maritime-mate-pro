...
const topicQuestions: Record<string, QuizQuestion[]> = {
  ...
  "cooling-hvac": [
    { id: 1, question: "COP nedir?", options: ["Sıkıştırma oranı", "Performans katsayısı (soğutma kapasitesi/kompresör işi)", "Soğutucu akışkan katsayısı", "Kondenser verimi"], correctAnswer: 1, explanation: "COP = QL/Wcomp, soğutma sisteminin etkinlik ölçüsüdür. Yüksek COP daha verimli sistemi gösterir.", category: "cooling" },
  ...
  "energy-efficiency": [
    { id: 1, question: "CII derecelendirmesinde 'C' ne anlama gelir?", options: ["good", "Orta (kabul edilebilir minimum)", "bad", "very bad"], correctAnswer: 1, explanation: "CII derecelendirmesi A (en iyi) – E (en kötü): C = orta/kabul edilebilir minimum. D ve E düzeltici eylem gerektirir.", category: "Enerji Verimliliği" },
