...
const topicQuestions: Record<string, QuizQuestion[]> = {
  ...
  "cooling-hvac": [
    { id: 1, question: "COP nedir?", options: ["Sıkıştırma oranı", "Performans katsayısı (soğutma kapasitesi/kompresör işi)", "Soğutucu akışkan katsayısı", "Kondenser verimi"], correctAnswer: 1, explanation: "COP = QL/Wcomp, soğutma sisteminin etkinlik ölçüsüdür. Yüksek COP daha verimli sistemi gösterir.", category: "Soğutma" },
