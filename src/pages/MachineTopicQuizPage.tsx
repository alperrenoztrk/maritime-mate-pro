...
const topicQuestions: Record<string, QuizQuestion[]> = {
  thermodynamics: [
    { id: 1, question: "Carnot çevriminin verimi hangi parametrelere bağlıdır?", options: ["Yalnızca basınç", "Sıcak ve soğuk kaynak sıcaklıkları", "Hacim ve basınç", "Akışkan türü"], correctAnswer: 1, explanation: "Carnot verimi η = 1 − TL/TH formülüyle yalnızca kaynak sıcaklıklarına bağlıdır.", category: "Termodinamik" },
    { id: 2, question: "Adyabatik süreçte hangi büyüklük sabit kalır?", options: ["Temperature", "Pressure", "Entropi", "Volume"], correctAnswer: 2, explanation: "Adyabatik tersinir süreçte entropi sabit kalır (izentropik süreç).", category: "Termodinamik" },
    ...
    { id: 4, question: "LMTD neyi ifade eder?", options: ["Logaritmik ortalama tork farkı", "Log mean temperature difference", "Lineer minimum sıcaklık değeri", "Akış hızı ortalaması"], correctAnswer: 1, explanation: "LMTD, ısı eşanjörlerinde ısı transfer hesaplarında kullanılan logaritmik ortalama sıcaklık farkıdır.", category: "Termodinamik" },
  ...
  "fluid-mechanics": [
    ...
    { id: 2, question: "Reynolds sayısı 4000'den büyük olduğunda akış rejimi nedir?", options: ["Laminer", "Geçiş bölgesi", "Turbulent", "Durağan"], correctAnswer: 2, explanation: "Re > 4000 değerinde akış türbülanslı kabul edilir.", category: "Akışkanlar" },
    ...
    { id: 5, question: "NPSHa nedir?", options: ["Pompa çıkış basıncı", "Net pozitif emme yüksekliği (mevcut)", "Nominal pompa seçim yüksekliği", "Boru kayıp katsayısı"], correctAnswer: 1, explanation: "NPSHa: pompanın emme tarafında kavitasyona karşı mevcut olan basınç farkıdır.", category: "Akışkanlar" },
  ],
  "machine-elements": [
  ...
  "diesel-engines": [
    ...
    { id: 3, question: "SFOC birimi nedir?", options: ["kg/hour", "g/kW·h", "L/mil", "tons/day"], correctAnswer: 1, explanation: "SFOC (Specific Fuel Oil Consumption) birimi g/kW·h'dir; düşük değer daha yüksek verim demektir.", category: "Dizel Motor" },
  ...
  auxiliary: [
    { id: 1, question: "Acil jeneratör ne kadar sürede devreye girmelidir?", options: ["10 saniye", "30 saniye", "45 saniye", "60 saniye"], correctAnswer: 2, explanation: "SOLAS II-1/Reg.44 gereği acil jeneratör 45 saniye içinde tam yükü besleyecek şekilde devreye girmelidir.", category: "Auxiliary Machinery" },
    { id: 2, question: "Separatörde Stokes yasası neyi belirler?", options: ["Yakıt kalitesini", "Parçacık ayrışma hızını", "Disk sayısını", "Motor verimini"], correctAnswer: 1, explanation: "Stokes yasası, yerçekimi/santrifüj kuvveti altında parçacıkların ayrışma hızını belirler.", category: "Auxiliary Machinery" },
    { id: 3, question: "Kazan emniyet valfi hangi basınçta açmalıdır?", options: ["Çalışma basıncının %50 fazlasında", "Set basıncının %3'ü içinde", "Çalışma basıncının 2 katında", "Herhangi bir basınçta"], correctAnswer: 1, explanation: "Emniyet valfi set basıncının ±%3'ü içinde açmalıdır.", category: "Auxiliary Machinery" },
    { id: 4, question: "Reverse power relay ne işe yarar?", options: ["Voltaj düşüşünü önler", "Jeneratörün motor olarak çalışmasını engeller", "Frekansı sabitler", "Yükü dengeler"], correctAnswer: 1, explanation: "Reverse power relay, jeneratörün şebekeden güç çekmesini (motorlaşmasını) algılayarak devreden çıkarır.", category: "Auxiliary Machinery" },
    { id: 5, question: "Tatlı su jeneratöründe vakum neden gereklidir?", options: ["Suyun tadını iyileştirir", "Düşük sıcaklıkta buharlaşmayı sağlar", "Enerji tasarrufu sağlar", "Tuz oranını kontrol eder"], correctAnswer: 1, explanation: "Vakum ortamında su 40–60°C gibi düşük sıcaklıklarda buharlaşır, böylece atık ısı kullanılabilir.", category: "Auxiliary Machinery" },
  ],
  "fuel-technology": [
    { id: 1, question: "CCAI nedir?", options: ["Yakıtın viskozite ölçüsü", "Yakıtın tutuşabilirlik göstergesi", "Karbon emisyon katsayısı", "Kükürt analiz indeksi"], correctAnswer: 1, explanation: "CCAI (Calculated Carbon Aromaticity Index), yakıtın tutuşma kalitesini gösteren bir indekstir. CCAI < 870 iyidir.", category: "fuel" },
    { id: 2, question: "HFO'dan MGO'ya geçişte en büyük risk nedir?", options: ["Yüksek maliyet", "Termal şok", "Düşük viskozite", "Tank kapasitesi"], correctAnswer: 1, explanation: "Ani sıcaklık değişimi (termal şok) pompa, enjektör ve boru bağlantılarında hasara yol açabilir.", category: "fuel" },
    { id: 3, question: "ISO 8217 neyi standartlaştırır?", options: ["Motor performansını", "Deniz yakıtı kalitesini", "Emisyon limitlerini", "Yağlama yağı özelliklerini"], correctAnswer: 1, explanation: "ISO 8217, deniz yakıtlarının kalite parametrelerini (viskozite, yoğunluk, kükürt, su, sediment vb.) standartlaştırır.", category: "fuel" },
    { id: 4, question: "Settling tank sıcaklığı HFO için ne olmalıdır?", options: ["40°C", "55°C", "70°C", "90°C"], correctAnswer: 2, explanation: "HFO settling tank sıcaklığı ~70°C'de tutularak su ve katı maddelerin yerçekimiyle çökmesi sağlanır.", category: "fuel" },
    { id: 5, question: "BDN kaç yıl saklanmalıdır?", options: ["1 yıl", "2 yıl", "3 yıl", "5 yıl"], correctAnswer: 2, explanation: "MARPOL Annex VI gereği Bunker Delivery Note en az 3 yıl saklanmalıdır.", category: "fuel" },
  ],
  "cooling-hvac": [
    { id: 1, question: "COP nedir?", options: ["Compression ratio", "Performans katsayısı (soğutma kapasitesi/kompresör işi)", "Soğutucu akışkan katsayısı", "Kondenser verimi"], correctAnswer: 1, explanation: "COP = QL/Wcomp, soğutma sisteminin etkinlik ölçüsüdür. Yüksek COP daha verimli sistemi gösterir.", category: "cooling" },
    { id: 2, question: "R-717 hangi akışkandır?", options: ["Freon", "Amonyak (NH₃)", "CO₂", "Propan"], correctAnswer: 1, explanation: "R-717 amonyaktır. Yüksek verimli ancak toksik ve yanıcıdır; özel güvenlik önlemleri gerektirir.", category: "cooling" },
    { id: 3, question: "Provision soğutma odası sıcaklığı ne olmalıdır?", options: ["-25°C ile -18°C arası (donmuş)", "+2°C ile +5°C arası (taze)", "Her ikisi de doğru", "+10°C ile +15°C arası"], correctAnswer: 2, explanation: "Donmuş ürünler -25°C ile -18°C, taze ürünler +2°C ile +5°C arasında muhafaza edilir.", category: "cooling" },
    { id: 4, question: "Kigali Değişikliği neyi hedefler?", options: ["ODS maddelerinin yasaklanması", "HFC'lerin kademeli azaltılması", "CO₂ emisyonlarının düşürülmesi", "NOx limitlerinin sıkılaştırılması"], correctAnswer: 1, explanation: "Kigali Değişikliği (2016), Montreal Protokolü kapsamında HFC soğutucu akışkanların kademeli azaltılmasını hedefler.", category: "cooling" },
    { id: 5, question: "Subcooling ne anlama gelir?", options: ["Soğutucunun aşırı ısınması", "Kondenser çıkışında sıvının doyma sıcaklığının altına soğutulması", "Evaporatörde tam buharlaşma", "Kompresör süperheat değeri"], correctAnswer: 1, explanation: "Subcooling, kondenser çıkışında sıvı soğutucunun doyma sıcaklığının birkaç derece altına soğutulmasıdır.", category: "cooling" },
  ],
  electrical: [
  ...
  "energy-efficiency": [
    ...
    { id: 2, question: "EEXI hangi gemiler için zorunludur?", options: ["Yalnızca yeni gemiler", "2023 sonrası tüm mevcut gemiler (400 GT üzeri)", "Yalnızca tankerler", "Yalnızca konteyner gemileri"], correctAnswer: 1, explanation: "EEXI (Energy Efficiency Existing Ship Index) 2023'ten itibaren 400 GT üzeri tüm mevcut gemiler için zorunludur.", category: "Energy Efficiency" },
    { id: 3, question: "SEEMP ne içerir?", options: ["Yalnızca CII hesabı", "Enerji verimliliği yönetim planı, CII hesabı ve iyileştirme önlemleri", "Yalnızca yakıt raporu", "Emisyon ölçüm sonuçları"], correctAnswer: 1, explanation: "SEEMP (Ship Energy Efficiency Management Plan): enerji verimliliği politikası, CII izleme ve iyileştirme planını içerir.", category: "Energy Efficiency" },
    { id: 4, question: "Trim optimizasyonu yakıt tasarrufunu nasıl sağlar?", options: ["Motor gücünü artırır", "Gövde direncini azaltarak daha düşük güç gerektirir", "Yakıt kalitesini değiştirir", "Pervane verimini düşürür"], correctAnswer: 1, explanation: "Optimum trim, dalga direncini ve toplam gövde direncini minimize ederek daha düşük güçle aynı hızı sağlar.", category: "Energy Efficiency" },
    { id: 5, question: "WHR sistemi ne yapar?", options: ["Yakıtı önceden ısıtır", "Egzoz gazı atık ısısını elektrik veya buhar enerjisine dönüştürür", "Soğutma suyu sıcaklığını düşürür", "Balast suyunu arıtır"], correctAnswer: 1, explanation: "WHR (Waste Heat Recovery): egzoz gazı ve soğutma suyu atık ısısını kullanarak elektrik üretir veya buhar sağlar.", category: "Energy Efficiency" },
  ],
};
