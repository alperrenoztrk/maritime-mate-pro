...
const SECTIONS = [
  {
    ...
    icon: Anchor,
    to: "/machine-topics/ship-systems/topic/deck-machinery",
  ...
  },
  {
    ...
    icon: Compass,
    to: "/machine-topics/ship-systems/topic/nav-systems",
  ...
  },
  {
    ...
    icon: Wrench,
    to: "/machine-topics/ship-systems/topic/main-engine",
  ...
  },
  {
    ...
    icon: Gauge,
    to: "/machine-topics/ship-systems/topic/auxiliary",
        ...
        <div className="relative z-10 mx-auto flex max-w-lg flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            {SECTIONS.map((section) => (
              ...
              >
                <div
                  className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${section.color}`}
                >
