...
const machinerySystems: MachineSystem[] = [
  {
    ...
    specs: ["2-Stroke / 4-Stroke", "50–80.000 kW", "80–120 RPM"],
  },
  {
    ...
    specs: ["Diesel Generator", "500–3000 kW", "720/900 RPM"],
  },
  {
    ...
    specs: ["440V / 6.6kV", "60 Hz", "3-Phase AC"],
  },
  {
    name: "Yakıt & Yağ",
  ...
  },
  {
    ...
    specs: ["Centrifugal / Reciprocating", "0.5–200 m³/h", "Otomatik Start"],
  },
  {
    name: "Soğutma & HVAC",
    ...
    specs: ["Fresh Water / Sea Water", "Heat Exchanger", "R-134a / R-407C"],
  },
  {
    name: "Kazanlar",
  ...
  },
  {
    ...
    specs: ["Hidrolik / Elektrik", "SWL Certified", "Fren Sistemi"],
  },
];
...
const engineTypes: EngineType[] = [
  {
    ...
    fuel: "HFO / VLSFO / MGO",
    usage: "Container, tanker, bulk carrier",
    ...
    advantages: ["High thermal efficiency and low SFOC", "Able to run on heavy fuels", "Long service life and robustness"],
    disadvantages: ["NOx/SOx emissions (requires SCR, scrubber)", "Long downtime for periodic overhaul", "High weight and volume"],
  },
  {
    ...
    usage: "LNG carrier, new-generation container ship",
    ...
    advantages: ["SOx/PM emissions almost zero", "NOx Tier III uyumu kolay", "Fuel flexibility (LNG + diesel)"],
    disadvantages: ["Cryogenic storage and FGSS complexity", "Risk of methane slip", "High initial investment cost"],
  },
  {
    title: "Gaz Türbini",
    icon: Wind,
    ...
    powerRange: "5 – 40 MW",
    efficiency: "%30–38",
    fuel: "MGO / Natural Gas",
    usage: "Warship, fast ferry",
    ...
    advantages: ["Very high power-to-weight ratio", "Low vibration and quiet running", "Fast start-up"],
    disadvantages: ["Low efficiency at part load", "Requires high-quality fuel", "Expensive hot section maintenance"],
  },
  {
    title: "Buhar Türbini",
    icon: Flame,
    ...
    advantages: ["Smooth torque delivery", "Able to make use of boil-off gas", "Continuous operation at high power"],
    disadvantages: ["Low efficiency compared with modern diesels", "Complex boiler/condenser maintenance", "High mass and volume"],
  },
  {
    ...
    efficiency: "%40–48",
    fuel: "MGO / Batarya",
    usage: "DP vessel, cruise ship, tug",
    ...
    advantages: ["Good efficiency at part load", "Layout flexibility and low noise", "Fast power response with batteries"],
    disadvantages: ["Power electronics cooling requirement", "High investment and integration complexity", "Need for harmonic control"],
  },
  {
    ...
    powerRange: "5 – 25 MW",
    efficiency: "%45–50",
    fuel: "Electric (from generators)",
    usage: "Cruise ship, icebreaker, DP",
    ...
    advantages: ["360° manevra kabiliyeti", "Shorter shaft line and improved efficiency", "Low noise and vibration"],
    disadvantages: ["High investment cost", "Sealing and maintenance sensitivity", "Requires a strong electrical infrastructure"],
  },
];
  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-border/50 bg-card/80 shadow-sm">
      <table className="w-full text-micro">
        ...
        <tbody>
          {[
            { name: "Dizel", power: "0.5–80+", eff: "High", effColor: "text-emerald-500", maint: "Regular overhaul", use: "Large merchant ships" },
            { name: "Gaz Türbini", power: "5–40", eff: "Part load ↓", effColor: "text-amber-500", maint: "Yüksek maliyet", use: "Warship, ferry" },
            { name: "Buhar Türbini", power: "10–50", eff: "Orta", effColor: "text-amber-500", maint: "Boiler maintenance", use: "LNG carrier, icebreaker" },
            { name: "Nükleer", power: "50–200+", eff: "High", effColor: "text-emerald-500", maint: "Special licence", use: "Aircraft carrier, submarine" },
            { name: "Dizel-Elektrik", power: "1–30", eff: "good", effColor: "text-emerald-500", maint: "Battery maintenance", use: "DP, kruvaziyer" },
            { name: "Dual-Fuel", power: "2–80", eff: "High", effColor: "text-emerald-500", maint: "FGSS maintenance", use: "LNG, konteyner" },
            { name: "Yakıt Hücresi", power: "0.1–5", eff: "Çok yüksek", effColor: "text-emerald-500", maint: "Stack replacement", use: "Pilot feribot" },
          ].map((row) => (
