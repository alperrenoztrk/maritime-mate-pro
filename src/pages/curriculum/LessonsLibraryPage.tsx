...
import { BookOpen, Ship, Wrench } from "lucide-react";
...
export default function LessonsLibraryPage() {
  ...
  return (
    <LibraryPageShell
      title={activeView === "deck" ? "Güverte Kitaplığı" : activeView === "machine" ? "Makine Kitaplığı" : "Dersler"}
      icon={activeView === "deck" ? Ship : activeView === "machine" ? Wrench : BookOpen}
    >
      <SEO
