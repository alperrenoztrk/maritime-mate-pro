...
const sections: RuleSection[] = [
  {
    ...
    rules: [
      ...
      "Rule 19 — Conduct of Vessels in Restricted Visibility: speed must be reduced to a safe speed; alter course to starboard to avoid a vessel detected by radar, and do not alter to port for a vessel abaft the beam.",
    ],
  },
  {
    title: "Navigation Lights and Shapes",
    icon: Eye,
    source: "COLREG Part C — Lights and Shapes",
    rules: [
  ...
  },
  {
    ...
    rules: [
      ...
      "SART: 9 GHz radar transponder; appears on the radar as 12 dots, range about 5 NM.",
    ],
  },
  {
